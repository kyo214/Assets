...
public static class SelectableColorExtensions
{
	...
	{
		return target.SetNormalColor(color, color);
	}
	...
	{
		return target.SetHighlightedColor(color, color);
	}
	...
	{
		return target.SetPressedColor(color, color);
	}
	...
	{
		return target.SetSelectedColor(color, color);
	}
	...
	{
		return target.SetDisabledColor(color, color);
	}
