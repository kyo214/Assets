...
public class PaintContext
{
	...
	private void FindTerrainTilesUnlimited(bool sharedBoundaryTexel, bool fillOutsideTerrain)
	{
		...
		Predicate<Terrain> filter = (Terrain t) =>
		{
	...
	public void GatherHeightmap()
	{
		...
		GatherInternal((ITerrainInfo t) => t.terrain.terrainData.heightmapTexture, new Color(0f, 0f, 0f, 0f), "PaintContext.GatherHeightmap", blitMaterial, 0, (ITerrainInfo t) =>
		{
	...
	public void ScatterHeightmap(string editorUndoName)
	{
		...
		blitMaterial.SetFloat("_Height_Offset", 0f);
		blitMaterial.SetFloat("_Height_Scale", 1f);
		ScatterInternal((ITerrainInfo t) => t.terrain.terrainData.heightmapTexture, "PaintContext.ScatterHeightmap", blitMaterial, 0, (ITerrainInfo t) =>
		{
	...
	{
		ScatterInternal((ITerrainInfo t) =>
		{
	...
	public void GatherAlphamap(TerrainLayer inputLayer, bool addLayerIfDoesntExist = true)
	{
		...
		}, new Color(0f, 0f, 0f, 0f), "PaintContext.GatherAlphamap", copyTerrainLayerMaterial, 0, (ITerrainInfo t) =>
		{
