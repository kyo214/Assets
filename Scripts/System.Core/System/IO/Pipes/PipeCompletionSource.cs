...
internal abstract class PipeCompletionSource<TResult> : TaskCompletionSource<TResult>
{
		...
		: base(TaskCreationOptions.RunContinuationsAsynchronously)
	{
		...
		_overlapped = _threadPoolBinding.AllocateNativeOverlapped((uint errorCode, uint numBytes, NativeOverlapped* pOverlapped) =>
		{
	...
	internal unsafe void RegisterForCancellation(CancellationToken cancellationToken)
	{
		...
		{
		case 0:
			_cancellationRegistration = cancellationToken.Register((object thisRef) =>
			{
