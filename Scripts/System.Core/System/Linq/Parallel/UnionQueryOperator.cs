...
internal sealed class UnionQueryOperator<TInputOutput> : BinaryQueryOperator<TInputOutput, TInputOutput, TInputOutput>
{
	private class UnionQueryOperatorEnumerator<TLeftKey, TRightKey> : QueryOperatorEnumerator<TInputOutput, int>
	{
		...
		internal override bool MoveNext(ref TInputOutput currentElement, ref int currentKey)
		{
			...
			if (_leftSource != null)
			{
				TLeftKey currentKey2 = default;
				Pair<TInputOutput, NoKeyMemoizationRequired> currentElement2 = default;
				int num = 0;
			...
			{
				TRightKey currentKey3 = default;
				Pair<TInputOutput, NoKeyMemoizationRequired> currentElement3 = default;
