...
internal abstract class QueryTask
{
	...
	private static Action<object> s_baseWorkDelegate = (object o) =>
	{
	...
	{
		return Task.Factory.StartNew(s_baseWorkDelegate, this, default, TaskCreationOptions.PreferFairness | TaskCreationOptions.AttachedToParent, taskScheduler);
	}
