...
internal sealed class DebugViewWriter : ExpressionVisitor
{
	...
	{
		VisitExpressions(open, separator, expressions, (T e) =>
		{
			Visit(e);
		});
	}
	...
	{
		VisitExpressions('(', ',', expressions, (ParameterExpression variable) =>
		{
	...
	protected internal override Expression VisitListInit(ListInitExpression node)
	{
		...
		VisitExpressions('{', ',', node.Initializers, (ElementInit e) =>
		{
			VisitElementInit(e);
		});
		return node;
	...
	protected override MemberListBinding VisitMemberListBinding(MemberListBinding binding)
	{
		...
		Out(Flow.Space, "=", Flow.Space);
		VisitExpressions('{', ',', binding.Initializers, (ElementInit e) =>
		{
			VisitElementInit(e);
		});
		return binding;
	...
	protected override MemberMemberBinding VisitMemberMemberBinding(MemberMemberBinding binding)
	{
		Out(binding.Member.Name);
		Out(Flow.Space, "=", Flow.Space);
		VisitExpressions('{', ',', binding.Bindings, (MemberBinding e) =>
		{
	...
	{
		Visit(node.NewExpression);
		VisitExpressions('{', ',', node.Bindings, (MemberBinding e) =>
		{
			VisitMemberBinding(e);
		});
		return node;
