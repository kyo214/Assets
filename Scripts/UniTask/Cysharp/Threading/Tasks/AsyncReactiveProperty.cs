...
public class AsyncReactiveProperty<T> : IAsyncReactiveProperty<T>, IReadOnlyAsyncReactiveProperty<T>, IUniTaskAsyncEnumerable<T>, IDisposable
{
	private sealed class WaitAsyncSource : IUniTaskSource<T>, IUniTaskSource, IValueTaskSource, IValueTaskSource<T>, ITriggerHandler<T>, ITaskPoolNode<WaitAsyncSource>
	{
		...
		ref WaitAsyncSource ITaskPoolNode<WaitAsyncSource>.NextNode => ref Cysharp_002EThreading_002ETasks_002EITaskPoolNode_003CCysharp_002EThreading_002ETasks_002EAsyncReactiveProperty_003CT_003E_002EWaitAsyncSource_003E_002Eget_NextNode();

		ITriggerHandler<T> ITriggerHandler<T>.Prev { get; set; }

		ITriggerHandler<T> ITriggerHandler<T>.Next { get; set; }

		private ref WaitAsyncSource Cysharp_002EThreading_002ETasks_002EITaskPoolNode_003CCysharp_002EThreading_002ETasks_002EAsyncReactiveProperty_003CT_003E_002EWaitAsyncSource_003E_002Eget_NextNode()
		{
			return ref nextNode;
		}
