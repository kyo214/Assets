...
public class GUI
{
	...
	public class ClipScope : Scope
	{
		...
		{
			BeginClip(position, scrollOffset, default, resetOffset: false);
		}
	...
	[CompilerGenerated]
	private static GenericStack scrollViewStates__BackingField;
	...
	internal static GenericStack scrollViewStates
	{
		...
		get
		{
			return scrollViewStates__BackingField;
		}
		[CompilerGenerated]
		set
		{
			scrollViewStates__BackingField = value;
		}
	}
