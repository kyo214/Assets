...
public class CT_PlotArea
{
	...
	{
		return ((surfaceChartField != null) ? surfaceChartField.Select((CT_SurfaceChart x) => x.GetSeriesCount()).Sum() : 0) + ((lineChartField != null) ? lineChartField.Select((CT_LineChart x) => x.GetSeriesCount()).Sum() : 0) + ((bubbleChartField != null) ? bubbleChartField.Select((CT_BubbleChart x) => x.GetSeriesCount()).Sum() : 0) + ((bar3DChartField != null) ? bar3DChartField.Select((CT_Bar3DChart x) => x.GetSeriesCount()).Sum() : 0) + ((area3DChartField != null) ? area3DChartField.Select((CT_Area3DChart x) => x.GetSeriesCount()).Sum() : 0) + ((doughnutChartField != null) ? doughnutChartField.Select((CT_DoughnutChart x) => x.GetSeriesCount()).Sum() : 0) + ((pie3DChartField != null) ? pie3DChartField.Select((CT_Pie3DChart x) => x.GetSeriesCount()).Sum() : 0) + ((line3DChartField != null) ? line3DChartField.Select((CT_Line3DChart x) => x.GetSeriesCount()).Sum() : 0) + ((surface3DChartField != null) ? surface3DChartField.Select((CT_Surface3DChart x) => x.GetSeriesCount()).Sum() : 0) + ((barChartField != null) ? barChartField.Select((CT_BarChart x) => x.GetSeriesCount()).Sum() : 0) + ((radarChartField != null) ? radarChartField.Select((CT_RadarChart x) => x.GetSeriesCount()).Sum() : 0) + ((areaChartField != null) ? areaChartField.Select((CT_AreaChart x) => x.GetSeriesCount()).Sum() : 0) + ((scatterChartField != null) ? scatterChartField.Select((CT_ScatterChart x) => x.GetSeriesCount()).Sum() : 0) + ((ofPieChartField != null) ? ofPieChartField.Select((CT_OfPieChart x) => x.GetSeriesCount()).Sum() : 0) + ((pieChartField != null) ? pieChartField.Select((CT_PieChart x) => x.GetSeriesCount()).Sum() : 0) + ((stockChartField != null) ? stockChartField.Select((CT_StockChart x) => x.GetSeriesCount()).Sum() : 0);
	}

	public CT_BarChart AddNewBarChart()
	{
		CT_BarChart cT_BarChart = new CT_BarChart();
		if (barChartField == null)
		{
			barChartField = new List<CT_BarChart>();
		}
		barChartField.Add(cT_BarChart);
		return cT_BarChart;
	}
	...
	public CT_DateAx AddNewDateAx()
	{
		...
		if (dateAxField == null)
		{
			dateAxField = new List<CT_DateAx>();
		}
		dateAxField.Add(cT_DateAx);
		return cT_DateAx;
	}
}
