...
public class CT_LineProperties
{
	...
	public bool capSpecified
	{
		get
		{
			return capField != ST_LineCap.NONE;
		}
		set
		{
	...
	public bool cmpdSpecified
	{
		get
		{
			return cmpdField != ST_CompoundLine.NONE;
		}
		set
		{
	...
	public bool algnSpecified
	{
		get
		{
			return algnField != ST_PenAlignment.NONE;
		}
		set
		{
