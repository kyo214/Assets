...
public class CT_ShapeLocking
{
	...
	internal void Write(StreamWriter sw, string nodeName)
	{
		...
		XmlHelper.WriteAttribute(sw, "noRot", noRot, writeIfBlank: false);
		...
		XmlHelper.WriteAttribute(sw, "noEditPoints", noEditPoints, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "noAdjustHandles", noAdjustHandles, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "noChangeArrowheads", noChangeArrowheads, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "noChangeShapeType", noChangeShapeType, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "noTextEdit", noTextEdit, writeIfBlank: false);
		if (extLst == null)
		{
			sw.Write("/>");
			return;
