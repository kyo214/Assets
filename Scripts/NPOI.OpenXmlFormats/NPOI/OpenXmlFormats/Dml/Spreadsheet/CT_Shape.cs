...
public class CT_Shape
{
	...
	internal void Write(StreamWriter sw, string nodeName)
	{
		...
		XmlHelper.WriteAttribute(sw, "macro", macro, writeIfBlank: true);
		XmlHelper.WriteAttribute(sw, "textlink", textlink, writeIfBlank: true);
		XmlHelper.WriteAttribute(sw, "fLocksText", fLocksText, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "fPublished", fPublished, writeIfBlank: false);
		sw.Write(">");
		if (nvSpPr != null)
		{
