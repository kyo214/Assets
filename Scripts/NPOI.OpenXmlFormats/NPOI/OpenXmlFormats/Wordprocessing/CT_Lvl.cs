...
public class CT_Lvl
{
	...
	public static CT_Lvl Parse(XmlNode node, XmlNamespaceManager namespaceManager)
	{
		...
		{
			cT_Lvl.tentative = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attributes["w:tentative"].Value, ignoreCase: true);
			cT_Lvl.tentativeSpecified = true;
		}
	...
	internal void Write(StreamWriter sw, string nodeName)
	{
		...
		if (tentative != ST_OnOff.off || tentativeFieldSpecified)
		{
