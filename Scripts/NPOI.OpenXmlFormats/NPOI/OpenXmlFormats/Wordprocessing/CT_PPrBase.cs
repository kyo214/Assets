...
public class CT_PPrBase
{
	...
	public virtual bool IsEmpty
	{
		get
		{
			if (pStyleField == null && keepNextField == null && keepLinesField == null && pageBreakBeforeField == null && framePrField == null && widowControlField == null && numPrField == null && suppressLineNumbersField == null && pBdrField == null && shdField == null && tabsField == null && suppressAutoHyphensField == null && kinsokuField == null && wordWrapField == null && overflowPunctField == null && topLinePunctField == null && autoSpaceDEField == null && autoSpaceDNField == null && bidiField == null && adjustRightIndField == null && snapToGridField == null && spacingField == null && indField == null && contextualSpacingField == null && mirrorIndentsField == null && suppressOverlapField == null && jcField == null && textDirectionField == null && textAlignmentField == null && textboxTightWrapField == null && outlineLvlField == null && divIdField == null)
			{
				return cnfStyleField == null;
			}
			return false;
		}
	}
