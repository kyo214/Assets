...
public class CT_AbstractNum
{
	...
	{
		return new CT_AbstractNum
		{
			abstractNumIdField = abstractNumIdField,
			lvlField = new List<CT_Lvl>(lvlField),
			multiLevelTypeField = multiLevelTypeField,
			nameField = nameField,
			nsidField = nsidField,
			numStyleLinkField = numStyleLinkField,
			styleLinkField = styleLinkField,
			tmplField = tmplField
		};
	}
