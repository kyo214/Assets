...
public class CT_RPr
{
	...
	{
		return dstrikeField != null;
	}

	public CT_OnOff AddNewDstrike()
	{
		if (dstrikeField == null)
		{
			dstrikeField = new CT_OnOff();
		}
		return dstrikeField;
	}
	...
	{
		return imprintField != null;
	}

	public CT_OnOff AddNewImprint()
	{
		if (imprintField == null)
		{
			imprintField = new CT_OnOff();
		}
		return imprintField;
	}
	...
	{
		return smallCapsField != null;
	}

	public CT_OnOff AddNewSmallCaps()
	{
		if (smallCapsField == null)
		{
			smallCapsField = new CT_OnOff();
		}
		return smallCapsField;
	}
	...
	public CT_SignedTwipsMeasure AddNewSpacing()
	{
		...
		{
			spacingField = new CT_SignedTwipsMeasure();
		}
		return spacingField;
	}
	...
	{
		highlightField = new CT_Highlight();
		return highlightField;
	}
}
