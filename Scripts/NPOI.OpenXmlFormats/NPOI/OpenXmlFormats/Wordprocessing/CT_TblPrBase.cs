...
public class CT_TblPrBase
{
	...
	public CT_String tblCaption
	{
		get
		{
			return tblCaptionField;
		}
		set
		{
			tblCaptionField = value;
		}
	}
	...
	public CT_String tblDescription
	{
		get
		{
			return tblDescriptionField;
		}
		set
		{
			tblDescriptionField = value;
		}
	}
	...
	public static CT_TblPrBase Parse(XmlNode node, XmlNamespaceManager namespaceManager)
	{
		...
		foreach (XmlNode childNode in node.ChildNodes)
		{
			...
			{
				cT_TblPrBase.tblCaption = CT_String.Parse(childNode, namespaceManager);
			}
			else if (childNode.LocalName == "tblDescription")
			{
				cT_TblPrBase.tblDescription = CT_String.Parse(childNode, namespaceManager);
			}
		}
		return cT_TblPrBase;
	}
	...
	internal void Write(StreamWriter sw, string nodeName)
	{
		...
		if (tblCaption != null)
		{
			tblCaption.Write(sw, "tblCaption");
		}
		if (tblDescription != null)
		{
			tblDescription.Write(sw, "tblDescription");
		}
		sw.Write($"</w:{nodeName}>");
	}
