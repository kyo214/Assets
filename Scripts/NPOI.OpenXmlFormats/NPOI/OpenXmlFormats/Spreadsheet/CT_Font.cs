...
public class CT_Font
{
	...
	public CT_Font Clone()
	{
		...
		if (name != null)
		{
			cT_Font.AddNewName().val = name.val;
		}
		if (charset != null)
		{
			foreach (CT_IntProperty item in charset)
			{
				cT_Font.AddNewCharset().val = item.val;
			}
		}
		if (family != null)
		{
			...
			{
				cT_Font.AddNewFamily().val = item2.val;
			}
		}
		if (b != null)
		{
		...
		if (strike != null)
		{
			...
			{
				cT_Font.AddNewStrike().val = item5.val;
			}
		}
		if (outline != null)
		{
		...
		if (color != null)
		{
			foreach (CT_Color item6 in color)
			{
				...
				cT_Color.themeSpecified = item6.themeSpecified;
				cT_Color.rgb = item6.rgb;
				cT_Color.rgbSpecified = item6.rgbSpecified;
				cT_Color.tint = item6.tint;
				cT_Color.tintSpecified = item6.tintSpecified;
				cT_Color.auto = item6.auto;
				cT_Color.autoSpecified = item6.autoSpecified;
			}
		}
		if (sz != null)
		{
			...
			{
				cT_Font.AddNewSz().val = item7.val;
			}
		}
		if (u != null)
		{
		...
		if (vertAlign != null)
		{
			...
			{
				cT_Font.AddNewVertAlign().val = item9.val;
			}
		}
		if (scheme != null)
		{
			foreach (CT_FontScheme item10 in scheme)
			{
				cT_Font.AddNewScheme().val = item10.val;
			}
		}
		return cT_Font;
	}
