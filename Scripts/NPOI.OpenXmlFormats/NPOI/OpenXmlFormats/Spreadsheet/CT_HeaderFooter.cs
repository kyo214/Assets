...
public class CT_HeaderFooter
{
	...
	internal void Write(StreamWriter sw, string nodeName)
	{
		...
		if (oddHeader == null && oddFooter == null && evenHeader == null && firstHeader == null && firstFooter == null)
		{
			sw.Write("/>");
			return;
		}
		...
		if (oddHeader != null)
		{
			sw.Write($"<oddHeader><![CDATA[{oddHeader}]]></oddHeader>");
		}
		if (oddFooter != null)
		{
			sw.Write($"<oddFooter><![CDATA[{oddFooter}]]></oddFooter>");
		}
		if (evenHeader != null)
		{
			sw.Write($"<evenHeader><![CDATA[{evenHeader}]]></evenHeader>");
		}
		if (evenFooter != null)
		{
			sw.Write($"<evenFooter><![CDATA[{evenFooter}]]></evenFooter>");
		}
		if (firstHeader != null)
		{
			sw.Write($"<firstHeader><![CDATA[{firstHeader}]]></firstHeader>");
		}
		if (firstFooter != null)
		{
			sw.Write($"<firstFooter><![CDATA[{firstFooter}]]></firstFooter>");
		}
		sw.Write($"</{nodeName}>");
	}
}
