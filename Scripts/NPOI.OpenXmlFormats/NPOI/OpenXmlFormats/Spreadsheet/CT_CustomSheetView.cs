...
public class CT_CustomSheetView
{
	...
	internal void Write(StreamWriter sw, string nodeName)
	{
		...
		XmlHelper.WriteAttribute(sw, "showPageBreaks", showPageBreaks, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "showFormulas", showFormulas, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "showGridLines", showGridLines, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "showRowCol", showRowCol, writeIfBlank: false);
		...
		XmlHelper.WriteAttribute(sw, "printArea", printArea, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "filter", filter, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "showAutoFilter", showAutoFilter, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "hiddenRows", hiddenRows, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "hiddenColumns", hiddenColumns, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "state", state.ToString());
		XmlHelper.WriteAttribute(sw, "filterUnique", filterUnique, writeIfBlank: false);
