...
public class CT_SortCondition
{
	...
	public static CT_SortCondition Parse(XmlNode node, XmlNamespaceManager namespaceManager)
	{
		...
		{
			cT_SortCondition.iconSet = XmlHelper.GetEnumValueFromString<ST_IconSetType>(node.Attributes["iconSet"].Value);
		}
	...
	internal void Write(StreamWriter sw, string nodeName)
	{
		...
		XmlHelper.WriteAttribute(sw, "iconSet", XmlHelper.GetEnumValue(iconSet));
