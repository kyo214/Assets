...
public class CT_Border
{
	...
	{
		sw.Write($"<{nodeName}");
		XmlHelper.WriteAttribute(sw, "diagonalUp", diagonalUp, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "diagonalDown", diagonalDown, writeIfBlank: false);
		XmlHelper.WriteAttribute(sw, "outline", outline, writeIfBlank: false);
		sw.Write(">");
		if (left != null)
		{
			left.Write(sw, "left");
	...
	public CT_Border Copy()
	{
		...
		{
			bottomField = ((bottomField == null) ? null : bottomField.Copy()),
			topField = ((topField == null) ? null : topField.Copy()),
			rightField = ((rightField == null) ? null : rightField.Copy()),
			leftField = ((leftField == null) ? null : leftField.Copy()),
			diagonalField = ((diagonalField == null) ? null : diagonalField.Copy()),
			verticalField = ((verticalField == null) ? null : verticalField.Copy()),
			horizontalField = ((horizontalField == null) ? null : horizontalField.Copy()),
			diagonalUpField = diagonalUpField,
			diagonalUpFieldSpecified = diagonalUpFieldSpecified,
			diagonalDownField = diagonalDownField,
			diagonalDownFieldSpecified = diagonalDownFieldSpecified,
	...
	public static CT_Border Parse(string p)
	{
		...
		return Parse(xmlDocument.DocumentElement, CT_Fill.CreateDefaultNSM());
	}
