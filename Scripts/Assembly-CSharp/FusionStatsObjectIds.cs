...
public class FusionStatsObjectIds : Fusion.Behaviour, IFusionStatsView
{
	...
	bool IFusionStatsView.isActiveAndEnabled => base.isActiveAndEnabled;

	Transform IFusionStatsView.transform => base.transform;
	...
	void IFusionStatsView.Refresh()
	{
		...
		NetworkObject networkObject = _fusionStats.Object;
		...
		{
			bool hasInputAuthority = networkObject.HasInputAuthority;
			...
			bool flag = networkObject.HasStateAuthority || networkObject.Runner.IsServer;
