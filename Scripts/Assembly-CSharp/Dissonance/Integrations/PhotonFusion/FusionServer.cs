...
public class FusionServer : BaseServer<FusionServer, FusionClient, FusionPeer>
{
	[NotNull]
	private readonly FusionCommsNetwork _network;
	...
	{
		_network.SendToClient(connection, packet, reliable: true);
	}

	protected override void SendUnreliable(FusionPeer connection, ArraySegment<byte> packet)
	{
		_network.SendToClient(connection, packet, reliable: false);
	}
