	...
	public void SyncMatWithProceduralTextureAsset()
	{
		if (!(m_Material == null))
		{
			if (proceduralTexAssetAlbedo != null)
			{
				...
				m_Material.SetVector("_InputSize_Albedo", new Vector3(proceduralTexAssetAlbedo.Tinput.width, proceduralTexAssetAlbedo.Tinput.height, 1f / (float)proceduralTexAssetAlbedo.invT.height));
			...
			if (proceduralTexAssetNormal != null)
			{
				...
				m_Material.SetVector("_InputSize_Normal", new Vector3(proceduralTexAssetNormal.Tinput.width, proceduralTexAssetNormal.Tinput.height, 1f / (float)proceduralTexAssetNormal.invT.height));
			...
			if (proceduralTexAssetMask != null)
			{
				...
				m_Material.SetVector("_InputSize_Mask", new Vector3(proceduralTexAssetMask.Tinput.width, proceduralTexAssetMask.Tinput.height, 1f / (float)proceduralTexAssetMask.invT.height));
