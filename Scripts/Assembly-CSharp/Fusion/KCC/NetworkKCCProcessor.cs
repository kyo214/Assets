...
public abstract class NetworkKCCProcessor : NetworkBehaviour, IKCCProcessor, IKCCProcessorProvider, IKCCInteractionProvider
{
	private static Changed<NetworkKCCProcessor> _0024IL2CPP_CHANGED;

	private static ChangedDelegate<NetworkKCCProcessor> _0024IL2CPP_CHANGED_DELEGATE;

	private static NetworkBehaviourCallbacks<NetworkKCCProcessor> _0024IL2CPP_NETWORK_BEHAVIOUR_CALLBACKS;
