...
public class ZipArchiveEntry
{
	...
	private CheckSumAndSizeWriteStream GetDataCompressor(Stream backingStream, bool leaveBackingStreamOpen, EventHandler onClose)
	{
		...
		return new CheckSumAndSizeWriteStream(baseStream, backingStream, leaveOpenOnClose, this, onClose, (long initialPosition, long currentPosition, uint checkSum, Stream backing, ZipArchiveEntry thisRef, EventHandler closeHandler) =>
		{
	...
	private Stream OpenInWriteMode()
	{
		...
		CheckSumAndSizeWriteStream dataCompressor = GetDataCompressor(_archive.ArchiveStream, leaveBackingStreamOpen: true, (object o, EventArgs e) =>
		{
	...
	private Stream OpenInUpdateMode()
	{
		...
		return new WrappedStream(UncompressedData, this, (ZipArchiveEntry thisRef) =>
		{
