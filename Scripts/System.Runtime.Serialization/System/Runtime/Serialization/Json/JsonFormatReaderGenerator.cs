...
internal sealed class JsonFormatReaderGenerator
{
	private class CriticalHelper
	{
		...
		{
			return (XmlReaderDelegator xr, XmlObjectSerializerReadContextComplexJson ctx, XmlDictionaryString emptyDS, XmlDictionaryString inm, CollectionDataContract cc) =>
			{
