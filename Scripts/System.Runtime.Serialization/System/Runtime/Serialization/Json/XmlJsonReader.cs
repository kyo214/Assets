...
internal class XmlJsonReader : XmlBaseReader, IXmlJsonReaderInitializer
{
	...
	public override bool Read()
	{
		...
		{
			byte[] buffer2 = base.BufferReader.GetBuffer(4, out var offset2);
		...
		{
			byte[] buffer3 = base.BufferReader.GetBuffer(4, out var offset3);
	...
	{
		byte[] buffer = base.BufferReader.GetBuffer(1, out var offset, out var offsetMax);
		if (offset < offsetMax)
		{
			ch = buffer[offset];
			return true;
