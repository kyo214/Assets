...
internal sealed class XmlFormatWriterGenerator
{
	private class CriticalHelper
	{
		...
		{
			return (XmlWriterDelegator xw, object obj, XmlObjectSerializerWriteContext ctx, ClassDataContract ctr) =>
			{
		...
		{
			return (XmlWriterDelegator xw, object obj, XmlObjectSerializerWriteContext ctx, CollectionDataContract ctr) =>
			{
