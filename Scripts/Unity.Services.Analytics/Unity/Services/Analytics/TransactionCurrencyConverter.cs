...
{
	private readonly Dictionary<string, int> m_Iso4217CurrencyMinorUnits = new Dictionary<string, int>(StringComparer.Ordinal)
	{
		{ "AFN", 2 },
		{ "EUR", 2 },
		{ "ALL", 2 },
	...
	public long Convert(string currencyCode, double value)
	{
		...
		string key = currencyCode.ToUpperInvariant();
		if (m_Iso4217CurrencyMinorUnits.TryGetValue(key, out var value2))
		{
			return (long)(value * Math.Pow(10.0, value2));
		}
