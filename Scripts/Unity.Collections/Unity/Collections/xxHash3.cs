...
public static class xxHash3
{
	...
	public struct StreamingState
	{
		...
		private StreamingStateData State = default;
	...
	public unsafe delegate ulong Hash64Long_0000071F_0024PostfixBurstDelegate(byte* input, byte* dest, long length, byte* secret);

	internal static class Hash64Long_0000071F_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Hash64Long_0000071F_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static Hash64Long_0000071F_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	public unsafe delegate void Hash128Long_00000726_0024PostfixBurstDelegate(byte* input, byte* dest, long length, byte* secret, out uint4 result);

	internal static class Hash128Long_00000726_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Hash128Long_00000726_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static Hash128Long_00000726_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		return Hash64Long_0000071F_0024BurstDirectCall.Invoke(input, dest, length, secret);
	}
	...
	private unsafe static void Hash128Len4To8(byte* input, long len, byte* secret, ulong seed, out uint4 result)
	{
		...
		ulong num5 = Common.umul128(num3 ^ num4, (ulong)(-7046029288634856825L + (len << 2)), out var high);
		high += num5 << 1;
		num5 ^= high >> 3;
	...
	private unsafe static void Hash128Len9To16(byte* input, long len, byte* secret, ulong seed, out uint4 result)
	{
		...
		long num5 = (long)Common.umul128(num3 ^ num4 ^ num, 11400714785074694791uL, out var high) + (len - 1 << 54);
		num4 ^= num2;
		high += num4 + Mul32To64((uint)num4, 2246822518u);
		ulong h = Common.umul128((ulong)num5 ^ Swap64(high), 14029467366897019727uL, out var high2);
	...
	{
		Hash128Long_00000726_0024BurstDirectCall.Invoke(input, dest, length, secret, out result);
	}
