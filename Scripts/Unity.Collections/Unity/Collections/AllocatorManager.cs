...
public static class AllocatorManager
{
	...
	public struct AllocatorHandle : IAllocator, IDisposable
	{
		...
		public static implicit operator AllocatorHandle(Allocator a)
		{
			...
			{
				Index = (ushort)(a & (Allocator)0xFFFF),
	...
	{
		public delegate int Try_00000980_0024PostfixBurstDelegate(IntPtr allocatorState, ref Block block);

		internal static class Try_00000980_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Try_00000980_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Try_00000980_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			return Try_00000980_0024BurstDirectCall.Invoke(allocatorState, ref block);
		}
	...
	{
		public delegate int Try_0000098E_0024PostfixBurstDelegate(IntPtr allocatorState, ref Block block);

		internal static class Try_0000098E_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Try_0000098E_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Try_0000098E_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public static int Try(IntPtr allocatorState, ref Block block)
		{
			return Try_0000098E_0024BurstDirectCall.Invoke(allocatorState, ref block);
		}
	...
	{
		return handle.Allocate<AllocatorHandle, T>(default, items);
	}
	...
	internal static AllocatorHandle Register(IntPtr allocatorState, FunctionPointer<TryFunction> functionPointer)
	{
		...
		int error = ConcurrentMask.TryAllocate(ref SharedStatics.IsInstalled.Ref.Data, out var offset, 1, SharedStatics.IsInstalled.Ref.Data.Length, 1);
		AllocatorHandle result = default;
	...
	public static void Initialize_0024StackAllocator_Try_00000980_0024BurstDirectCall()
	{
		StackAllocator.Try_00000980_0024BurstDirectCall.Initialize();
	}

	public static void Initialize_0024SlabAllocator_Try_0000098E_0024BurstDirectCall()
	{
		SlabAllocator.Try_0000098E_0024BurstDirectCall.Initialize();
	}
}
