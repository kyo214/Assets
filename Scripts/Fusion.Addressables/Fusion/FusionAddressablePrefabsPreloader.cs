...
public class FusionAddressablePrefabsPreloader : MonoBehaviour
{
	...
	private async Task Start()
	{
		...
		{
			if (entry.Item2 is NetworkPrefabSourceUnityAddressable networkPrefabSourceUnityAddressable)
			{
				object runtimeKey = networkPrefabSourceUnityAddressable.Address.RuntimeKey;
