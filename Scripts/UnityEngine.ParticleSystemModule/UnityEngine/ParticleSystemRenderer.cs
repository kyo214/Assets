...
public sealed class ParticleSystemRenderer : Renderer
{
	...
	{
		BakeTextureOutput bakeTextureOutput = BakeTextureInternal(verticesTexture, indicesTexture, camera, options, out var indexCount);
	...
	{
		BakeTextureOutput bakeTextureOutput = BakeTrailsTextureInternal(verticesTexture, indicesTexture, camera, options, out var indexCount);
		verticesTexture = bakeTextureOutput.vertices;
		indicesTexture = bakeTextureOutput.indices;
		return indexCount;
	}
