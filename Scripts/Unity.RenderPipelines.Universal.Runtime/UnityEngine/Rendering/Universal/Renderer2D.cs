...
internal class Renderer2D : ScriptableRenderer
{
	...
	{
		RenderPassInputSummary result = default;
	...
	public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
	{
		...
		bool flag7 = base.DebugHandler == null || !base.DebugHandler.HDRDebugViewIsActive(ref cameraData);
		bool flag8 = component != null && component.enabled;
		bool flag9 = (cameraData.captureActions != null) & resolveFinalTarget;
		bool resolveToScreen = resolveFinalTarget && !flag9 && !flag6 && !flag5 && !flag8;
		if (flag2)
		{
			...
			postProcessPass.Setup(in cameraTargetDescriptor, in source, resolveToScreen, in depth, colorGradingLutHandle, (RTHandle)null, flag5, (afterPostProcessColorHandle.nameID == ScriptableRenderer.k_CameraTarget.nameID) & flag7);
