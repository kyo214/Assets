...
public sealed class UniversalRenderer : ScriptableRenderer
{
		...
		: base(data)
	{
		...
		ForwardLights.InitParams initParams = default;
	...
	public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
	{
		...
		bool flag2 = RenderingLayerUtils.RequireRenderingLayers(this, base.rendererFeatures, descriptor.msaaSamples, out var combinedEvent, out var combinedMaskSize);
		if (IsGLDevice())
		{
			flag2 = false;
		}
	...
	private void CreateCameraRenderTarget(ScriptableRenderContext context, ref RenderTextureDescriptor descriptor, bool primedDepth, CommandBuffer cmd, ref CameraData cameraData)
	{
		using (new ProfilingScope(null, Profiling.createCameraRenderTarget))
		{
			...
			if (m_CameraDepthAttachment == null || m_CameraDepthAttachment.nameID != BuiltinRenderTextureType.CameraTarget)
			{
				...
				if (SystemInfo.graphicsDeviceType == GraphicsDeviceType.Direct3D11)
				{
					RenderingUtils.ReAllocateIfNeeded(ref m_CameraDepthAttachment_D3d_11, in descriptor2, FilterMode.Point, TextureWrapMode.Clamp, isShadowMap: false, 1, 0f, "_CameraDepthAttachment_Temp");
