...
public static class ShortcutExtensions
{
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.aspect, (float x) =>
		{
			target.aspect = x;
		}, endValue, duration);
	...
	{
		TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.To(() => target.backgroundColor, (Color x) =>
		{
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.farClipPlane, (float x) =>
		{
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.fieldOfView, (float x) =>
		{
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.nearClipPlane, (float x) =>
		{
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.orthographicSize, (float x) =>
		{
	...
	{
		TweenerCore<Rect, Rect, RectOptions> tweenerCore = DOTween.To(() => target.pixelRect, (Rect x) =>
		{
			target.pixelRect = x;
		}, endValue, duration);
		tweenerCore.SetTarget(target);
	...
	{
		TweenerCore<Rect, Rect, RectOptions> tweenerCore = DOTween.To(() => target.rect, (Rect x) =>
		{
			target.rect = x;
		}, endValue, duration);
		tweenerCore.SetTarget(target);
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.intensity, (float x) =>
		{
			target.intensity = x;
		}, endValue, duration);
		tweenerCore.SetTarget(target);
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.shadowStrength, (float x) =>
		{
	...
	public static TweenerCore<Color, Color, ColorOptions> DOColor(this Material target, Color endValue, string property, float duration)
	{
		...
		TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.To(() => target.GetColor(property), (Color x) =>
		{
	...
	public static TweenerCore<Color, Color, ColorOptions> DOColor(this Material target, Color endValue, int propertyID, float duration)
	{
		...
		TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.To(() => target.GetColor(propertyID), (Color x) =>
		{
	...
	public static TweenerCore<Color, Color, ColorOptions> DOFade(this Material target, float endValue, string property, float duration)
	{
		...
		TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.ToAlpha(() => target.GetColor(property), (Color x) =>
		{
			target.SetColor(property, x);
		}, endValue, duration);
		tweenerCore.SetTarget(target);
	...
	public static TweenerCore<Color, Color, ColorOptions> DOFade(this Material target, float endValue, int propertyID, float duration)
	{
		...
		TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.ToAlpha(() => target.GetColor(propertyID), (Color x) =>
		{
			target.SetColor(propertyID, x);
		}, endValue, duration);
		tweenerCore.SetTarget(target);
	...
	public static TweenerCore<float, float, FloatOptions> DOFloat(this Material target, float endValue, string property, float duration)
	{
		...
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.GetFloat(property), (float x) =>
		{
	...
	public static TweenerCore<float, float, FloatOptions> DOFloat(this Material target, float endValue, int propertyID, float duration)
	{
		...
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.GetFloat(propertyID), (float x) =>
		{
	...
	{
		TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.mainTextureOffset, (Vector2 x) =>
		{
	...
	public static TweenerCore<Vector2, Vector2, VectorOptions> DOOffset(this Material target, Vector2 endValue, string property, float duration)
	{
		...
		TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.GetTextureOffset(property), (Vector2 x) =>
		{
	...
	{
		TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.mainTextureScale, (Vector2 x) =>
		{
	...
	public static TweenerCore<Vector2, Vector2, VectorOptions> DOTiling(this Material target, Vector2 endValue, string property, float duration)
	{
		...
		TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.GetTextureScale(property), (Vector2 x) =>
		{
	...
	public static TweenerCore<Vector4, Vector4, VectorOptions> DOVector(this Material target, Vector4 endValue, string property, float duration)
	{
		...
		TweenerCore<Vector4, Vector4, VectorOptions> tweenerCore = DOTween.To(() => target.GetVector(property), (Vector4 x) =>
		{
	...
	public static TweenerCore<Vector4, Vector4, VectorOptions> DOVector(this Material target, Vector4 endValue, int propertyID, float duration)
	{
		...
		TweenerCore<Vector4, Vector4, VectorOptions> tweenerCore = DOTween.To(() => target.GetVector(propertyID), (Vector4 x) =>
		{
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.time, (float x) =>
		{
			target.time = x;
		}, endValue, duration);
		tweenerCore.SetTarget(target);
	...
	{
		TweenerCore<Vector3, Vector3, VectorOptions> tweenerCore = DOTween.To(() => target.position, (Vector3 x) =>
		{
			target.position = x;
		}, endValue, duration);
	...
	{
		TweenerCore<Vector3, Vector3, VectorOptions> tweenerCore = DOTween.To(() => target.localPosition, (Vector3 x) =>
		{
	...
	{
		TweenerCore<Vector3, Vector3, VectorOptions> tweenerCore = DOTween.To(() => target.localScale, (Vector3 x) =>
		{
			target.localScale = x;
		}, endValue, duration);
		tweenerCore.SetTarget(target);
	...
	{
		TweenerCore<Vector3, Vector3, VectorOptions> obj = DOTween.To(endValue: new Vector3(endValue, endValue, endValue), getter: () => target.localScale, setter: (Vector3 x) =>
		{
			target.localScale = x;
		}, duration: duration);
	...
	public static Sequence DOLocalJump(this Transform target, Vector3 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
	{
		...
		bool offsetYSet = false;
		Sequence s = DOTween.Sequence();
		Tween yTween = DOTween.To(() => target.localPosition, (Vector3 x) =>
		{
			target.localPosition = x;
		}, new Vector3(0f, jumpPower, 0f), duration / (float)(numJumps * 2)).SetOptions(AxisConstraint.Y, snapping).SetEase(Ease.OutQuad)
			.SetRelative()
	...
	{
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.timeScale, (float x) =>
		{
			target.timeScale = x;
		}, endValue, duration);
		tweenerCore.SetTarget(target);
