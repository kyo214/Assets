...
internal class Panel : BaseVisualElementPanel
{
	...
	{
		ValidateLayout();
		VisualElement topElementUnderPointer = m_TopElementUnderPointers.GetTopElementUnderPointer(PointerId.mousePointerId, out var pickPosition, out var isTemporary);
