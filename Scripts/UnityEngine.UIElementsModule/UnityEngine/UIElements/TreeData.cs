...
{
	private readonly IList<int> m_RootItemIds = new List<int>();

	private readonly Dictionary<int, TreeViewItemData<T>> m_Tree = new Dictionary<int, TreeViewItemData<T>>();

	private readonly Dictionary<int, int> m_ParentIds = new Dictionary<int, int>();

	private readonly Dictionary<int, List<int>> m_ChildrenIds = new Dictionary<int, List<int>>();
