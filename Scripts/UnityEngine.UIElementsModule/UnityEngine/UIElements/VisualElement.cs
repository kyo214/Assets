...
public class VisualElement : Focusable, IResolvedStyle, IStylePropertyAnimations, ITransform, ITransitionAnimations, IExperimentalFeatures, IVisualElementScheduler
{
	...
	{
		return experimental.animation.Start((VisualElement e) => new Rect(e.resolvedStyle.left, e.resolvedStyle.top, e.resolvedStyle.width, e.resolvedStyle.height), to, durationMs, (VisualElement e, Rect c) =>
		{
			e.style.left = c.x;
			e.style.top = c.y;
	...
	{
		return experimental.animation.Start((VisualElement e) => new Vector2(e.resolvedStyle.left, e.resolvedStyle.top), to, durationMs, (VisualElement e, Vector2 c) =>
		{
			e.style.left = c.x;
			e.style.top = c.y;
		});
	...
	{
		return experimental.animation.Start((VisualElement e) => e.layout.size, to, durationMs, (VisualElement e, Vector2 c) =>
		{
			e.style.width = c.x;
			e.style.height = c.y;
		});
	...
	{
		return experimental.animation.Start((VisualElement e) => e.transform.scale.x, to, durationMs, (VisualElement e, float c) =>
		{
	...
	{
		return experimental.animation.Start((VisualElement e) => e.transform.position, to, durationMs, (VisualElement e, Vector3 c) =>
		{
	...
	{
		return experimental.animation.Start((VisualElement e) => e.transform.rotation, to, durationMs, (VisualElement e, Quaternion c) =>
		{
