...
internal class RenderChain : IDisposable
{
	...
	private LinkedPool<RenderChainCommand> m_CommandPool = new LinkedPool<RenderChainCommand>(() => new RenderChainCommand(), (RenderChainCommand cmd) =>
	{
	});
