...
internal class TouchScreenTextEditorEventHandler(TextElement textElement, TextEditingUtilities editingUtilities) : TextEditorEventHandler(textElement, editingUtilities)
{
