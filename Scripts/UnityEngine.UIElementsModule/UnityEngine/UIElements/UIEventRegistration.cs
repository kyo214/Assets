...
internal static class UIEventRegistration
{
	...
	static UIEventRegistration()
	{
		...
		GUIUtility.takeCapture = (Action)Delegate.Combine(GUIUtility.takeCapture, (Action)(() =>
		{
			TakeCapture();
		}));
		GUIUtility.releaseCapture = (Action)Delegate.Combine(GUIUtility.releaseCapture, (Action)(() =>
		{
			ReleaseCapture();
		}));
		...
		GUIUtility.cleanupRoots = (Action)Delegate.Combine(GUIUtility.cleanupRoots, (Action)(() =>
		{
			CleanupRoots();
		}));
		...
		GUIUtility.guiChanged = (Action)Delegate.Combine(GUIUtility.guiChanged, (Action)(() =>
		{
