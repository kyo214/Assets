...
{
	private readonly struct ChannelsMetadata(bool isPositional, float amplitudeMultiplier, ChannelPriority priority)
	{
		public readonly bool IsPositional = isPositional;

		public readonly float AmplitudeMultiplier = amplitudeMultiplier;

		public readonly ChannelPriority Priority = priority;
