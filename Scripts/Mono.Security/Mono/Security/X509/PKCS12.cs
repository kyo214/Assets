...
public class PKCS12 : ICloneable
{
			...
			if (_keyBagsChanged)
			{
				...
				foreach (SafeBag safeBag in _safeBags)
				{
					if (safeBag.BagOID.Equals("1.2.840.113549.1.12.10.1.1"))
					{
						...
						{
						case 2:
							_keyBags.Add(PKCS8.PrivateKeyInfo.DecodeDSA(privateKey, default));
							break;
						case 48:
					...
					else if (safeBag.BagOID.Equals("1.2.840.113549.1.12.10.1.2"))
					{
						...
						{
						case 2:
							_keyBags.Add(PKCS8.PrivateKeyInfo.DecodeDSA(privateKey2, default));
							break;
						case 48:
	...
	private void AddPrivateKey(PKCS8.PrivateKeyInfo pki)
	{
		...
		try
		{
			...
			{
				DSAParameters existingParameters = GetExistingParameters(out var found);
				if (found)
				{
	...
	public void AddPkcs8ShroudedKeyBag(AsymmetricAlgorithm aa, IDictionary attributes)
	{
		...
		while (!flag && num < _safeBags.Count)
		{
			...
			if (safeBag.BagOID.Equals("1.2.840.113549.1.12.10.1.2"))
			{
				...
				{
				case 2:
					asymmetricAlgorithm = PKCS8.PrivateKeyInfo.DecodeDSA(privateKey, default);
					break;
				case 48:
	...
	public AsymmetricAlgorithm GetAsymmetricAlgorithm(IDictionary attrs)
	{
		foreach (SafeBag safeBag in _safeBags)
		{
			...
			if (safeBag.BagOID.Equals("1.2.840.113549.1.12.10.1.1"))
			{
				...
				{
				case 2:
					result = PKCS8.PrivateKeyInfo.DecodeDSA(privateKey, default);
					break;
				case 48:
			...
			else if (safeBag.BagOID.Equals("1.2.840.113549.1.12.10.1.2"))
			{
				...
				{
				case 2:
					result = PKCS8.PrivateKeyInfo.DecodeDSA(privateKey2, default);
					break;
				case 48:
	...
	public IDictionary GetAttributes(AsymmetricAlgorithm aa)
	{
		...
		foreach (SafeBag safeBag in _safeBags)
		{
			...
			else if (safeBag.BagOID.Equals("1.2.840.113549.1.12.10.1.2"))
			{
				...
				{
				case 2:
					asymmetricAlgorithm = PKCS8.PrivateKeyInfo.DecodeDSA(privateKey2, default);
					break;
				case 48:
