...
public class CRLDistributionPointsExtension : X509Extension
{
	...
	public enum ReasonFlags
	{
		...
		KeyCompromise = 1,
		CACompromise = 2,
		AffiliationChanged = KeyCompromise | CACompromise,
		Superseded = 4,
		CessationOfOperation = KeyCompromise | Superseded,
		CertificateHold = CACompromise | Superseded,
		PrivilegeWithdrawn = AffiliationChanged | Superseded,
		AACompromise = 8
	}
