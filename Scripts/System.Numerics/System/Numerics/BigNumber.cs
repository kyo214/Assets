...
internal static class BigNumber
{
	...
	internal static bool TryParseBigInteger(string value, NumberStyles style, NumberFormatInfo info, out BigInteger result)
	{
		...
		return TryParseBigInteger((ReadOnlySpan<char>)value, style, info, out result);
	}
	...
	internal static BigInteger ParseBigInteger(string value, NumberStyles style, NumberFormatInfo info)
	{
		...
		return ParseBigInteger((ReadOnlySpan<char>)value, style, info);
	}
	...
	internal static string FormatBigInteger(BigInteger value, string format, NumberFormatInfo info)
	{
		int charsWritten;
		bool spanSuccess;
		return FormatBigInteger(targetSpan: false, value, format, format, info, default, out charsWritten, out spanSuccess);
	}
