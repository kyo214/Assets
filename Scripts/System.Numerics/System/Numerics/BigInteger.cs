...
public readonly struct BigInteger : IFormattable, IComparable, IComparable<BigInteger>, IEquatable<BigInteger>
{
	...
	public static BigInteger DivRem(BigInteger dividend, BigInteger divisor, out BigInteger remainder)
	{
		...
		if (flag2)
		{
			uint[] value = BigIntegerCalculator.Divide(dividend._bits, NumericsHelpers.Abs(divisor._sign), out var remainder2);
		...
		uint[] value2 = BigIntegerCalculator.Divide(dividend._bits, divisor._bits, out var remainder3);
	...
	{
		int bytesWritten = 0;
		return TryGetBytes(GetBytesMode.AllocateArray, default, isUnsigned, isBigEndian, ref bytesWritten);
	}
	...
	{
		int bytesWritten = 0;
		TryGetBytes(GetBytesMode.Count, default, isUnsigned, isBigEndian: false, ref bytesWritten);
		return bytesWritten;
	}
	...
	public static BigInteger operator <<(BigInteger value, int shift)
	{
		...
		bool partsForBitManipulation = GetPartsForBitManipulation(ref value, out var xd, out var xl);
