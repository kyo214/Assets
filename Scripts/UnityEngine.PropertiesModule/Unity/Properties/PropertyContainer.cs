...
public static class PropertyContainer
{
	...
	{
		public static readonly ObjectPool<GetPropertyVisitor> Pool = new ObjectPool<GetPropertyVisitor>(() => new GetPropertyVisitor(), null, (GetPropertyVisitor v) =>
		{
			v.Reset();
		});
	...
	{
		public static readonly ObjectPool<GetValueVisitor<TSrcValue>> Pool = new ObjectPool<GetValueVisitor<TSrcValue>>(() => new GetValueVisitor<TSrcValue>(), null, (GetValueVisitor<TSrcValue> v) =>
		{
			v.Reset();
		});
	...
	{
		public static readonly ObjectPool<ValueAtPathVisitor> Pool = new ObjectPool<ValueAtPathVisitor>(() => new ValueAtPathVisitor(), null, (ValueAtPathVisitor v) =>
		{
			v.Reset();
		});
	...
	{
		public static readonly ObjectPool<ExistsAtPathVisitor> Pool = new ObjectPool<ExistsAtPathVisitor>(() => new ExistsAtPathVisitor(), null, (ExistsAtPathVisitor v) =>
		{
			v.Reset();
		});
	...
	{
		public static readonly ObjectPool<SetValueVisitor<TSrcValue>> Pool = new ObjectPool<SetValueVisitor<TSrcValue>>(() => new SetValueVisitor<TSrcValue>(), null, (SetValueVisitor<TSrcValue> v) =>
		{
			v.Reset();
		});
	...
	public static bool TryAccept<TContainer>(IPropertyBagVisitor visitor, ref TContainer container, out VisitReturnCode returnCode, VisitParameters parameters = default(VisitParameters))
	{
		...
		if (TypeTraits<TContainer>.CanBeNull && EqualityComparer<TContainer>.Default.Equals(container, default))
		{
