...
public class XWPFRelation : POIXMLRelation
{
	...
	public static XWPFRelation THEME = new XWPFRelation("application/vnd.openxmlformats-officedocument.theme+xml", "http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme", "/word/theme/theme#.xml", null);
	...
	public static XWPFRelation IMAGE_SVG = new XWPFRelation("image/svg", "http://schemas.openxmlformats.org/officeDocument/2006/relationships/image", "/word/media/image#.svg", typeof(XWPFPictureData));

	public static XWPFRelation IMAGES = new XWPFRelation(null, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/image", null, typeof(XWPFPictureData));
