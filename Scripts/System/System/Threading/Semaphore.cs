...
public sealed class Semaphore : WaitHandle
{
	...
	public Semaphore(int initialCount, int maximumCount, string name)
	{
		...
		SafeWaitHandle safeWaitHandle = new SafeWaitHandle(CreateSemaphore_internal(initialCount, maximumCount, name, out var errorCode), ownsHandle: true);
	...
	private static OpenExistingResult OpenExistingWorker(string name, SemaphoreRights rights, out Semaphore result)
	{
		...
		result = null;
		SafeWaitHandle safeWaitHandle = new SafeWaitHandle(OpenSemaphore_internal(name, rights, out var errorCode), ownsHandle: true);
		if (safeWaitHandle.IsInvalid)
		{
