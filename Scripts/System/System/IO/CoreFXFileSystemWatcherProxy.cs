...
internal class CoreFXFileSystemWatcherProxy : IFileWatcher
{
	...
	protected void ProxyDispatch(object sender, FileAction action, FileSystemEventArgs args)
	{
		...
		object handle = null;
		Operation((IDictionary<object, System.IO.CoreFX.FileSystemWatcher> in_map, ConditionalWeakTable<object, FileSystemWatcher> out_map, IDictionary<object, object> event_map, object h) =>
		{
			event_map.TryGetValue(sender, out handle);
		});
		Operation(null, (System.IO.CoreFX.FileSystemWatcher _, FileSystemWatcher fsw) =>
		{
	...
	{
		object handle = null;
		Operation((IDictionary<object, System.IO.CoreFX.FileSystemWatcher> in_map, ConditionalWeakTable<object, FileSystemWatcher> out_map, IDictionary<object, object> event_map, object _) =>
		{
			event_map.TryGetValue(sender, out handle);
		});
		Operation(null, (System.IO.CoreFX.FileSystemWatcher _, FileSystemWatcher fsw) =>
	...
	public void StartDispatching(object handle)
	{
		if (handle != null)
		{
			Operation(null, (System.IO.CoreFX.FileSystemWatcher internal_fsw, FileSystemWatcher fsw) =>
			{
	...
	public void StopDispatching(object handle)
	{
		...
		Operation(null, null, handle, (System.IO.CoreFX.FileSystemWatcher internal_fsw, FileSystemWatcher fsw) =>
		{
