...
public class SortedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IDictionary, ICollection, IReadOnlyDictionary<TKey, TValue>, IReadOnlyCollection<KeyValuePair<TKey, TValue>>
{
	...
	public sealed class KeyCollection : ICollection<TKey>, IEnumerable<TKey>, IEnumerable, ICollection, IReadOnlyCollection<TKey>
	{
		...
		public void CopyTo(TKey[] array, int index)
		{
			...
			_dictionary._set.InOrderTreeWalk((SortedSet<KeyValuePair<TKey, TValue>>.Node node) =>
			{
	...
	public TValue this[TKey key]
	{
		get
		{
			...
			return (_set.FindNode(new KeyValuePair<TKey, TValue>(key, default)) ?? throw new KeyNotFoundException(global::SR.Format("The given key '{0}' was not present in the dictionary.", key.ToString()))).Item.Value;
		}
		set
		{
			if (key == null)
			...
			SortedSet<KeyValuePair<TKey, TValue>>.Node node = _set.FindNode(new KeyValuePair<TKey, TValue>(key, default));
			if (node == null)
			{
	...
	public bool ContainsValue(TValue value)
	{
		...
		if (value == null)
		{
			_set.InOrderTreeWalk((SortedSet<KeyValuePair<TKey, TValue>>.Node node) =>
			{
