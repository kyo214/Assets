...
public class Socket : IDisposable
{
	...
	internal sealed class AwaitableSocketAsyncEventArgs : SocketAsyncEventArgs, IValueTaskSource, IValueTaskSource<int>
	{
		...
		private static readonly Action<object> s_completedSentinel = (object state) =>
		{
			throw new Exception("s_completedSentinel");
		};

		private static readonly Action<object> s_availableSentinel = (object state) =>
		{
		...
		protected override void OnCompleted(SocketAsyncEventArgs _)
		{
			...
			ExecutionContext.Run(executionContext, (object runState) =>
			{
		...
		private void InvokeContinuation(Action<object> continuation, object state, bool forceAsync)
		{
			...
			if (scheduler != null)
			{
				...
				{
					synchronizationContext.Post((object s) =>
					{
	...
	private static readonly EventHandler<SocketAsyncEventArgs> AcceptCompletedHandler = (object s, SocketAsyncEventArgs e) =>
	{
		CompleteAccept((Socket)s, (TaskSocketAsyncEventArgs<Socket>)e);
	};

	private static readonly EventHandler<SocketAsyncEventArgs> ReceiveCompletedHandler = (object s, SocketAsyncEventArgs e) =>
	{
		CompleteSendReceive((Socket)s, (Int32TaskSocketAsyncEventArgs)e, isReceive: true);
	};

	private static readonly EventHandler<SocketAsyncEventArgs> SendCompletedHandler = (object s, SocketAsyncEventArgs e) =>
	{
	...
	private static AsyncCallback AcceptAsyncCallback = (IAsyncResult ares) =>
	{
	...
	private static IOAsyncCallback BeginAcceptCallback = (IOAsyncResult ares) =>
	{
	...
	private static IOAsyncCallback BeginAcceptReceiveCallback = (IOAsyncResult ares) =>
	{
		SocketAsyncResult socketAsyncResult = (SocketAsyncResult)ares;
		Socket socket = null;
		try
	...
	private static AsyncCallback ConnectAsyncCallback = (IAsyncResult ares) =>
	{
		SocketAsyncEventArgs e = (SocketAsyncEventArgs)((SocketAsyncResult)ares).AsyncState;
		if (Interlocked.Exchange(ref e.in_progress, 0) != 1)
		{
	...
	private static IOAsyncCallback BeginConnectCallback = (IOAsyncResult ares) =>
	{
		SocketAsyncResult socketAsyncResult = (SocketAsyncResult)ares;
	...
	private static AsyncCallback DisconnectAsyncCallback = (IAsyncResult ares) =>
	{
		SocketAsyncEventArgs e = (SocketAsyncEventArgs)((SocketAsyncResult)ares).AsyncState;
		if (Interlocked.Exchange(ref e.in_progress, 0) != 1)
		{
	...
	private static IOAsyncCallback BeginDisconnectCallback = (IOAsyncResult ares) =>
	{
		SocketAsyncResult socketAsyncResult = (SocketAsyncResult)ares;
		try
		{
	...
	private static AsyncCallback ReceiveAsyncCallback = (IAsyncResult ares) =>
	{
		SocketAsyncEventArgs e = (SocketAsyncEventArgs)((SocketAsyncResult)ares).AsyncState;
		if (Interlocked.Exchange(ref e.in_progress, 0) != 1)
		{
	...
	private unsafe static IOAsyncCallback BeginReceiveCallback = (IOAsyncResult ares) =>
	{
		SocketAsyncResult socketAsyncResult = (SocketAsyncResult)ares;
		int total = 0;
		try
	...
	private static IOAsyncCallback BeginReceiveGenericCallback = (IOAsyncResult ares) =>
	{
		SocketAsyncResult socketAsyncResult = (SocketAsyncResult)ares;
		int num = 0;
		try
	...
	private static AsyncCallback ReceiveFromAsyncCallback = (IAsyncResult ares) =>
	{
		SocketAsyncEventArgs e = (SocketAsyncEventArgs)((SocketAsyncResult)ares).AsyncState;
		if (Interlocked.Exchange(ref e.in_progress, 0) != 1)
		{
	...
	private static IOAsyncCallback BeginReceiveFromCallback = (IOAsyncResult ares) =>
	{
		SocketAsyncResult socketAsyncResult = (SocketAsyncResult)ares;
		int num = 0;
		try
	...
	private static AsyncCallback SendAsyncCallback = (IAsyncResult ares) =>
	{
		SocketAsyncEventArgs e = (SocketAsyncEventArgs)((SocketAsyncResult)ares).AsyncState;
		if (Interlocked.Exchange(ref e.in_progress, 0) != 1)
		{
	...
	private static IOAsyncCallback BeginSendGenericCallback = (IOAsyncResult ares) =>
	{
		SocketAsyncResult socketAsyncResult = (SocketAsyncResult)ares;
		int num = 0;
		try
	...
	private static AsyncCallback SendToAsyncCallback = (IAsyncResult ares) =>
	{
		SocketAsyncEventArgs e = (SocketAsyncEventArgs)((SocketAsyncResult)ares).AsyncState;
		if (Interlocked.Exchange(ref e.in_progress, 0) != 1)
		{
	...
	private Task<Socket> AcceptAsyncApm(Socket acceptSocket)
	{
		...
		BeginAccept(acceptSocket, 0, (IAsyncResult iar) =>
		{
	...
	internal Task ConnectAsync(EndPoint remoteEP)
	{
		...
		BeginConnect(remoteEP, (IAsyncResult iar) =>
		{
	...
	{
		TaskCompletionSource<bool> taskCompletionSource = new TaskCompletionSource<bool>(this);
		BeginConnect(address, port, (IAsyncResult iar) =>
		{
			TaskCompletionSource<bool> taskCompletionSource2 = (TaskCompletionSource<bool>)iar.AsyncState;
			try
			{
	...
	{
		TaskCompletionSource<bool> taskCompletionSource = new TaskCompletionSource<bool>(this);
		BeginConnect(addresses, port, (IAsyncResult iar) =>
		{
			TaskCompletionSource<bool> taskCompletionSource2 = (TaskCompletionSource<bool>)iar.AsyncState;
			try
			{
	...
	{
		TaskCompletionSource<bool> taskCompletionSource = new TaskCompletionSource<bool>(this);
		BeginConnect(host, port, (IAsyncResult iar) =>
		{
			TaskCompletionSource<bool> taskCompletionSource2 = (TaskCompletionSource<bool>)iar.AsyncState;
			try
			{
	...
	private Task<int> ReceiveAsyncApm(Memory<byte> buffer, SocketFlags socketFlags)
	{
		if (MemoryMarshal.TryGetArray((ReadOnlyMemory<byte>)buffer, out ArraySegment<byte> segment))
		{
			...
			BeginReceive(segment.Array, segment.Offset, segment.Count, socketFlags, (IAsyncResult iar) =>
			{
		...
		BeginReceive(array, 0, buffer.Length, socketFlags, (IAsyncResult iar) =>
		{
	...
	{
		TaskCompletionSource<int> taskCompletionSource = new TaskCompletionSource<int>(this);
		BeginReceive(buffers, socketFlags, (IAsyncResult iar) =>
		{
	...
	internal Task<SocketReceiveFromResult> ReceiveFromAsync(ArraySegment<byte> buffer, SocketFlags socketFlags, EndPoint remoteEndPoint)
	{
		...
		BeginReceiveFrom(buffer.Array, buffer.Offset, buffer.Count, socketFlags, ref stateTaskCompletionSource._field1, (IAsyncResult iar) =>
		{
	...
	internal Task<SocketReceiveMessageFromResult> ReceiveMessageFromAsync(ArraySegment<byte> buffer, SocketFlags socketFlags, EndPoint remoteEndPoint)
	{
		...
		BeginReceiveMessageFrom(buffer.Array, buffer.Offset, buffer.Count, socketFlags, ref stateTaskCompletionSource._field2, (IAsyncResult iar) =>
		{
	...
	private Task<int> SendAsyncApm(ReadOnlyMemory<byte> buffer, SocketFlags socketFlags)
	{
		...
		{
			TaskCompletionSource<int> taskCompletionSource = new TaskCompletionSource<int>(this);
			BeginSend(segment.Array, segment.Offset, segment.Count, socketFlags, (IAsyncResult iar) =>
			{
				TaskCompletionSource<int> taskCompletionSource3 = (TaskCompletionSource<int>)iar.AsyncState;
				try
				{
		...
		TaskCompletionSource<int> taskCompletionSource2 = new TaskCompletionSource<int>(this);
		BeginSend(array, 0, buffer.Length, socketFlags, (IAsyncResult iar) =>
		{
	...
	{
		TaskCompletionSource<int> taskCompletionSource = new TaskCompletionSource<int>(this);
		BeginSend(buffers, socketFlags, (IAsyncResult iar) =>
		{
			TaskCompletionSource<int> taskCompletionSource2 = (TaskCompletionSource<int>)iar.AsyncState;
			try
			{
	...
	{
		TaskCompletionSource<int> taskCompletionSource = new TaskCompletionSource<int>(this);
		BeginSendTo(buffer.Array, buffer.Offset, buffer.Count, socketFlags, remoteEP, (IAsyncResult iar) =>
		{
			TaskCompletionSource<int> taskCompletionSource2 = (TaskCompletionSource<int>)iar.AsyncState;
			try
			{
	...
	public IAsyncResult BeginConnect(string host, int port, AsyncCallback callback, object state)
	{
		...
		Dns.GetHostAddressesAsync(host).ContinueWith((Task<IPAddress[]> t) =>
		{
			if (t.IsFaulted)
			{
	...
	public bool SendAsync(SocketAsyncEventArgs e)
	{
		...
		else
		{
			...
			e.socket_async_result.Offset = e.Offset;
			e.socket_async_result.Size = e.Count;
			QueueIOSelectorJob(WriteSem, e.socket_async_result.Handle, new IOSelectorJob(IOOperation.Write, (IOAsyncResult s) =>
			{
	...
	public IAsyncResult BeginSend(byte[] buffer, int offset, int size, SocketFlags socketFlags, out SocketError errorCode, AsyncCallback callback, object state)
	{
		...
		QueueIOSelectorJob(WriteSem, socketAsyncResult.Handle, new IOSelectorJob(IOOperation.Write, (IOAsyncResult s) =>
		{
			BeginSendCallback((SocketAsyncResult)s, 0);
		}, socketAsyncResult));
		return socketAsyncResult;
	...
	private unsafe static void BeginSendCallback(SocketAsyncResult sockares, int sent_so_far)
	{
		...
		if (sockares.error == 0)
		{
			...
			if (sockares.Size > 0)
			{
				IOSelector.Add(sockares.Handle, new IOSelectorJob(IOOperation.Write, (IOAsyncResult s) =>
				{
	...
	public IAsyncResult BeginSendFile(string fileName, byte[] preBuffer, byte[] postBuffer, TransmitFileOptions flags, AsyncCallback callback, object state)
	{
		...
		return new SendFileAsyncResult(handler, handler.BeginInvoke(fileName, preBuffer, postBuffer, flags, (IAsyncResult ar) =>
		{
