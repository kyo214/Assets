...
internal abstract class SafeFreeCredentials : SafeHandle
{
	...
	public unsafe static int AcquireCredentialsHandle(string package, global::Interop.SspiCli.CredentialUse intent, ref global::Interop.SspiCli.SEC_WINNT_AUTH_IDENTITY_W authdata, out SafeFreeCredentials outCredential)
	{
		...
		int num = global::Interop.SspiCli.AcquireCredentialsHandleW(null, package, (int)intent, null, ref authdata, null, null, ref outCredential._handle, out var _);
		if (num != 0)
		{
	...
	public unsafe static int AcquireDefaultCredential(string package, global::Interop.SspiCli.CredentialUse intent, out SafeFreeCredentials outCredential)
	{
		...
		outCredential = new SafeFreeCredential_SECURITY();
		int num = global::Interop.SspiCli.AcquireCredentialsHandleW(null, package, (int)intent, null, IntPtr.Zero, null, null, ref outCredential._handle, out var _);
		if (num != 0)
		{
			outCredential.SetHandleAsInvalid();
		}
	...
	{
		outCredential = new SafeFreeCredential_SECURITY();
		int num = global::Interop.SspiCli.AcquireCredentialsHandleW(null, package, (int)intent, null, authdata, null, null, ref outCredential._handle, out var _);
		if (num != 0)
		{
			outCredential.SetHandleAsInvalid();
		}
