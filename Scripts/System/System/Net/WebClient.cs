...
public class WebClient : Component
{
	...
	public string UploadString(Uri address, string method, string data)
	{
		...
		try
		{
			...
			byte[] data2 = UploadDataInternal(address, method, bytes, out var request);
	...
	public string DownloadString(Uri address)
	{
		...
		try
		{
			byte[] data = DownloadDataInternal(address, out var request);
	...
	public void OpenWriteAsync(Uri address, string method, object userToken)
	{
		...
		try
		{
			_method = method;
			WebRequest request = (_webRequest = GetWebRequest(GetUri(address)));
			request.BeginGetRequestStream((IAsyncResult iar) =>
			{
	...
	public void UploadStringAsync(Uri address, string method, string data, object userToken)
	{
		...
		try
		{
			...
			_method = method;
			_contentLength = bytes.Length;
			UploadBitsAsync(_webRequest = GetWebRequest(GetUri(address)), null, bytes, 0, null, null, asyncOperation, (byte[] bytesResult, Exception error, AsyncOperation uploadAsyncOp) =>
			{
				string result = null;
	...
	public void UploadDataAsync(Uri address, string method, byte[] data, object userToken)
	{
		...
		try
		{
			...
			UploadBitsAsync(request, null, data, chunkSize, null, null, asyncOp, (byte[] result, Exception error, AsyncOperation uploadAsyncOp) =>
			{
	...
	public void UploadFileAsync(Uri address, string method, string fileName, object userToken)
	{
		...
		try
		{
			...
			bool needsHeaderAndBoundary = uri.Scheme != Uri.UriSchemeFile;
			OpenFileInternal(needsHeaderAndBoundary, fileName, ref fs, ref buffer, ref formHeaderBytes, ref boundaryBytes);
			UploadBitsAsync(_webRequest = GetWebRequest(uri), fs, buffer, 0, formHeaderBytes, boundaryBytes, asyncOp, (byte[] result, Exception error, AsyncOperation uploadAsyncOp) =>
			{
	...
	public void UploadValuesAsync(Uri address, string method, NameValueCollection data, object userToken)
	{
		...
		try
		{
			...
			UploadBitsAsync(request, null, valuesToUpload, chunkSize, null, null, asyncOp, (byte[] result, Exception error, AsyncOperation uploadAsyncOp) =>
			{
	...
	public Task<string> DownloadStringTaskAsync(Uri address)
	{
		...
		handler = (object sender, DownloadStringCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (DownloadStringCompletedEventArgs args) => args.Result, handler, (WebClient webClient, DownloadStringCompletedEventHandler completion) =>
			{
	...
	public Task<Stream> OpenReadTaskAsync(Uri address)
	{
		...
		handler = (object sender, OpenReadCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (OpenReadCompletedEventArgs args) => args.Result, handler, (WebClient webClient, OpenReadCompletedEventHandler completion) =>
			{
	...
	public Task<Stream> OpenWriteTaskAsync(Uri address, string method)
	{
		...
		handler = (object sender, OpenWriteCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (OpenWriteCompletedEventArgs args) => args.Result, handler, (WebClient webClient, OpenWriteCompletedEventHandler completion) =>
			{
	...
	public Task<string> UploadStringTaskAsync(Uri address, string method, string data)
	{
		...
		handler = (object sender, UploadStringCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (UploadStringCompletedEventArgs args) => args.Result, handler, (WebClient webClient, UploadStringCompletedEventHandler completion) =>
			{
	...
	public Task<byte[]> DownloadDataTaskAsync(Uri address)
	{
		...
		handler = (object sender, DownloadDataCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (DownloadDataCompletedEventArgs args) => args.Result, handler, (WebClient webClient, DownloadDataCompletedEventHandler completion) =>
			{
	...
	public Task DownloadFileTaskAsync(Uri address, string fileName)
	{
		...
		handler = (object sender, AsyncCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (AsyncCompletedEventArgs args) => (object)null, handler, (WebClient webClient, AsyncCompletedEventHandler completion) =>
			{
	...
	public Task<byte[]> UploadDataTaskAsync(Uri address, string method, byte[] data)
	{
		...
		handler = (object sender, UploadDataCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (UploadDataCompletedEventArgs args) => args.Result, handler, (WebClient webClient, UploadDataCompletedEventHandler completion) =>
			{
	...
	public Task<byte[]> UploadFileTaskAsync(Uri address, string method, string fileName)
	{
		...
		handler = (object sender, UploadFileCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (UploadFileCompletedEventArgs args) => args.Result, handler, (WebClient webClient, UploadFileCompletedEventHandler completion) =>
			{
	...
	public Task<byte[]> UploadValuesTaskAsync(Uri address, string method, NameValueCollection data)
	{
		...
		handler = (object sender, UploadValuesCompletedEventArgs e) =>
		{
			HandleCompletion(tcs, e, (UploadValuesCompletedEventArgs args) => args.Result, handler, (WebClient webClient, UploadValuesCompletedEventHandler completion) =>
			{
