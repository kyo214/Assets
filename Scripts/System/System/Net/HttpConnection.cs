...
internal sealed class HttpConnection
{
	...
	public HttpConnection(Socket sock, EndPointListener epl, bool secure, X509Certificate cert)
	{
		...
		{
			ssl_stream = epl.Listener.CreateSslStream(new NetworkStream(sock, ownsSocket: false), ownsStream: false, (object t, X509Certificate c, X509Chain ch, SslPolicyErrors e) =>
			{
				if (c == null)
				{
					return true;
