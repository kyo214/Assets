...
internal class MonoBtlsX509 : MonoBtlsObject
{
	...
	{
		int num = mono_btls_x509_get_hash(Handle.DangerousGetHandle(), out var data);
	...
	public byte[] GetSubjectKeyIdentifier()
	{
		...
		try
		{
			int ret = mono_btls_x509_get_subject_key_identifier(Handle.DangerousGetHandle(), out data, out var size);
