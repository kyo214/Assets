...
public class Explode : MonoBehaviour
{
	...
	[Range(0f, 1f)]
	public float farDamagePercent = 0.25f;
	...
	private void AddAffectedObjects(int colliderCount, ExplosiveDamage explosiveDamage, float chipAwayPercentage)
	{
		for (int i = 0; i < colliderCount; i++)
		{
			...
			if (componentInParent != null && !affectedDestructibles.ContainsKey(componentInParent))
			{
				affectedDestructibles.Add(componentInParent, explosiveDamage);
			}
		}
	}
}
