...
public class MMTouchJoystick : MonoBehaviour, IDragHandler, IEventSystemHandler, IEndDragHandler
{
	[Header("Camera")]
	...
	{
		if (JoystickValue != null && (HorizontalAxisEnabled || VerticalAxisEnabled))
		{
	...
	protected virtual void RotateIndicator()
	{
		if (_rotatingIndicatorIsNotNull)
		{
			...
			float angle = Mathf.Atan2(_joystickValue.y, _joystickValue.x) * 57.29578f;
