...
public sealed class GraphicsPathIterator : MarshalByRefObject, IDisposable
{
	...
	public int Count
	{
		get
		{
			int num = GDIPlus.GdipPathIterGetCount(new HandleRef(this, nativeIter), out var count);
			if (num != 0)
			{
	...
	public int SubpathCount
	{
		get
		{
			int num = GDIPlus.GdipPathIterGetSubpathCount(new HandleRef(this, nativeIter), out var count);
			if (num != 0)
			{
				throw SafeNativeMethods.Gdip.StatusException(num);
			}
	...
	{
		int num = GDIPlus.GdipPathIterNextSubpath(new HandleRef(this, nativeIter), out var resultCount, out var startIndex2, out var endIndex2, out isClosed);
		if (num != 0)
		{
			throw SafeNativeMethods.Gdip.StatusException(num);
		}
	...
	{
		int num = GDIPlus.GdipPathIterNextSubpathPath(new HandleRef(this, nativeIter), out var resultCount, new HandleRef(path, path?.nativePath ?? IntPtr.Zero), out isClosed);
		if (num != 0)
		{
			throw SafeNativeMethods.Gdip.StatusException(num);
		}
	...
	{
		int num = GDIPlus.GdipPathIterNextPathType(new HandleRef(this, nativeIter), out var resultCount, out pathType, out startIndex, out endIndex);
		if (num != 0)
		{
			throw SafeNativeMethods.Gdip.StatusException(num);
		}
	...
	{
		int num = GDIPlus.GdipPathIterNextMarker(new HandleRef(this, nativeIter), out var resultCount, out startIndex, out endIndex);
		if (num != 0)
		{
			throw SafeNativeMethods.Gdip.StatusException(num);
		}
	...
	{
		int num = GDIPlus.GdipPathIterNextMarkerPath(new HandleRef(this, nativeIter), out var resultCount, new HandleRef(path, path?.nativePath ?? IntPtr.Zero));
		if (num != 0)
		{
			throw SafeNativeMethods.Gdip.StatusException(num);
		}
	...
	{
		int num = GDIPlus.GdipPathIterHasCurve(new HandleRef(this, nativeIter), out var curve);
		if (num != 0)
		{
			throw SafeNativeMethods.Gdip.StatusException(num);
		}
