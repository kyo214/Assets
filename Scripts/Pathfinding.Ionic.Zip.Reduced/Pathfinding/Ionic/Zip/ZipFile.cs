...
public class ZipFile : IEnumerable<ZipEntry>, IDisposable, IEnumerable
{
	...
	public ZipErrorAction ZipErrorAction
	{
		...
		set
		{
			...
			if (_zipErrorAction != ZipErrorAction.InvokeErrorEvent && this.m_ZipError != null)
			{
				this.m_ZipError = null;
			}
		}
	}
	...
	{
		EventHandler<SaveProgressEventArgs> saveProgress = this.m_SaveProgress;
	...
	{
		EventHandler<ReadProgressEventArgs> readProgress = this.m_ReadProgress;
	...
	{
		EventHandler<ExtractProgressEventArgs> extractProgress = this.m_ExtractProgress;
	...
	{
		EventHandler<AddProgressEventArgs> addProgress = this.m_AddProgress;
		if (addProgress != null)
		{
	...
	private static ZipFile Read(string fileName, TextWriter statusMessageWriter, Encoding encoding, EventHandler<ReadProgressEventArgs> readProgress)
	{
		...
		if (readProgress != null)
		{
			zipFile.m_ReadProgress = readProgress;
		}
		if (zipFile.Verbose)
		{
