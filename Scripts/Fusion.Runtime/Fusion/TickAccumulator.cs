...
public struct TickAccumulator
{
	...
	{
		TickAccumulator result = default;
	...
	{
		return string.Format("[{0}: {1}={2}, {3}={4}, {5}={6}]", "TickAccumulator", "Running", Running, "Pending", Pending, "Remainder", Remainder);
	}
}
