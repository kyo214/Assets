...
internal static class ErrorCodeExt
{
	public static ShutdownReason ConvertToShutdownReason(short errorCode)
	{
		...
		case 32751:
			Log.DebugError("Fusion plug-in not found. Make sure to use a Fusion-type Photon Application ID.");
		...
		case 32762:
			Log.DebugError("All servers are busy. This is a temporary issue and the game logic should try again after a brief wait time.");
			return ShutdownReason.Error;
		default:
			return ShutdownReason.Error;
		}
