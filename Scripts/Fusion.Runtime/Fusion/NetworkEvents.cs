...
public class NetworkEvents : Behaviour, INetworkRunnerCallbacks
{
	...
	[Serializable]
	public class ReliableDataEvent : UnityEvent<NetworkRunner, PlayerRef, ArraySegment<byte>>
	{
	}
	...
	public RunnerEvent OnDisconnectedFromServer;
	...
	{
		OnReliableData?.Invoke(runner, player, data);
	}
