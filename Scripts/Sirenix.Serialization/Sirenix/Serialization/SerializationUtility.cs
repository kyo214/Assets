...
public static class SerializationUtility
{
	...
	{
		IDataWriter cachedWriter = GetCachedWriter(out var cache, format, stream, context);
		try
		{
			if (context != null)
			{
	...
	{
		IDataReader cachedReader = GetCachedReader(out var cache, format, stream, context);
		try
		{
			if (context != null)
			{
