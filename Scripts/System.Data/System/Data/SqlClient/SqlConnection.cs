...
public sealed class SqlConnection : DbConnection, ICloneable, IDbConnection, IDisposable
{
	...
	public override void Close()
	{
		...
		Guid clientConnectionId = default;
	...
	public override Task OpenAsync(CancellationToken cancellationToken)
	{
		...
		try
		{
			...
			{
				taskCompletionSource2.Task.ContinueWith((Task<object> t) =>
				{
					if (t.Exception != null)
					{
	...
	{
		SqlInfoMessageEventHandler sqlInfoMessageEventHandler = InfoMessage;
	...
	{
		outerTask = outerTask.ContinueWith((Task<T> task) =>
		{
