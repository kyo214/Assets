...
public static class GraphUtilities
{
	public static List<Vector3> GetContours(NavGraph graph)
	{
		...
		{
			GetContours(graph as INavmesh, (List<Int3> vertices, bool cycle) =>
			{
		...
		{
			GetContours(graph as GridGraph, (Vector3[] vertices) =>
			{
	...
	public static void GetContours(INavmesh navmesh, Action<List<Int3>, bool> results)
	{
		...
		navmesh.GetNodes((GraphNode _node) =>
		{
		...
		Polygon.TraceContours(outline, hasInEdge, (List<int> chain, bool cycle) =>
		{
