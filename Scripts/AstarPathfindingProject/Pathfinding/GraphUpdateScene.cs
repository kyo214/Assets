...
public class GraphUpdateScene : GraphModifier
{
	...
	{
		Color color = (selected ? new Color(227f / 255f, 61f / 255f, 22f / 255f, 1f) : new Color(227f / 255f, 61f / 255f, 22f / 255f, 0.9f));
		if (selected)
		{
		...
		if (convex)
		{
			...
			Gizmos.color = (selected ? new Color(227f / 255f, 61f / 255f, 22f / 255f, 1f) : new Color(227f / 255f, 61f / 255f, 22f / 255f, 0.9f));
