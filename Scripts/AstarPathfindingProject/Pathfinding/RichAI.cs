...
public class RichAI : AIBase, IAstarAI
{
	...
	protected static readonly Color GizmoColorPath = new Color(8f / 255f, 78f / 255f, 194f / 255f);
	...
	{
		nextCorners.Clear();
		Vector3 result = fn.Update(simulatedPosition, nextCorners, 2, out lastCorner, out var requiresRepath);
	...
	private void TraverseFunnel(RichFunnel fn, float deltaTime, out Vector3 nextPosition, out Quaternion nextRotation)
	{
		...
		Vector2 vector2 = movementPlane.ToPlane(vector, out var elevation);
