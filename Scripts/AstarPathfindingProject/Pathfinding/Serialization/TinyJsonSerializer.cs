...
public class TinyJsonSerializer
{
	...
	{
		serializers[typeof(float)] = (object v) =>
		{
			output.Append(((float)v).ToString("R", invariantCulture));
		};
		serializers[typeof(bool)] = (object v) =>
		{
			output.Append(((bool)v) ? "true" : "false");
		};
		serializers[typeof(Version)] = (serializers[typeof(uint)] = (serializers[typeof(int)] = (object v) =>
		{
			output.Append(v.ToString());
		}));
		serializers[typeof(string)] = (object v) =>
		{
			output.AppendFormat("\"{0}\"", v.ToString().Replace("\"", "\\\""));
		};
		serializers[typeof(Vector2)] = (object v) =>
		{
			output.AppendFormat("{{ \"x\": {0}, \"y\": {1} }}", ((Vector2)v).x.ToString("R", invariantCulture), ((Vector2)v).y.ToString("R", invariantCulture));
		};
		serializers[typeof(Vector3)] = (object v) =>
		{
		...
		serializers[typeof(Pathfinding.Util.Guid)] = (object v) =>
		{
			output.AppendFormat("{{ \"value\": \"{0}\" }}", v.ToString());
		};
		serializers[typeof(LayerMask)] = (object v) =>
		{
