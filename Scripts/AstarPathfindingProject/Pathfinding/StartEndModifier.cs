...
public class StartEndModifier : PathModifier
{
	...
	public override void Apply(Path _p)
	{
		...
		Vector3 vector = Snap(aBPath, exactStartPoint, start: true, out var forceAddPoint, out var closestConnectionIndex);
		Vector3 vector2 = Snap(aBPath, exactEndPoint, start: false, out var forceAddPoint2, out var closestConnectionIndex2);
		if (flag)
		{
