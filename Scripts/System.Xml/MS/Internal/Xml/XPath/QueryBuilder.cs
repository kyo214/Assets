...
internal sealed class QueryBuilder
{
	...
	private Query ProcessFilter(Filter root, Flags flags, out Props props)
	{
		...
		Query query = ProcessNode(root.Condition, Flags.None, out var props2);
	...
	{
		Query query = ProcessNode(root.Operand1, Flags.None, out var props2);
		Query query2 = ProcessNode(root.Operand2, Flags.None, out var props3);
		props = props2 | props3;
