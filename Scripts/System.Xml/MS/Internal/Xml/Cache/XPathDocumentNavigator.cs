...
internal sealed class XPathDocumentNavigator : XPathNavigator, IXmlLineInfo
{
	...
	{
		int num = _pageCurrent[_idxCurrent].Document.LookupIdElement(id, out var pageElem);
		if (num != 0)
		{
	...
	public override bool MoveToFollowing(string localName, string namespaceURI, XPathNavigator end)
	{
		...
		int followingEnd = GetFollowingEnd(end as XPathDocumentNavigator, useParentOfVirtual: false, out var pageEnd);
		if (_idxParent != 0)
		{
