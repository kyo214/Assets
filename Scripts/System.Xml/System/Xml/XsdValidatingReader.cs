...
internal class XsdValidatingReader : XmlReader, IXmlSchemaInfo, IXmlLineInfo, IXmlNamespaceResolver
{
	...
	public override object ReadContentAs(Type returnType, IXmlNamespaceResolver namespaceResolver)
	{
		...
		object value = InternalReadContentAsObject(unwrapTypedValue: false, out var originalStringValue);
		XmlSchemaType xmlSchemaType = ((NodeType == XmlNodeType.Attribute) ? AttributeXmlType : ElementXmlType);
		try
		{
			if (xmlSchemaType != null)
	...
	public override bool ReadElementContentAsBoolean()
	{
		...
		object value = InternalReadElementContentAsObject(out var xmlType);
		try
		{
	...
	public override string ReadElementContentAsString()
	{
		...
		object obj = InternalReadElementContentAsObject(out var xmlType);
		try
		{
			if (xmlType != null)
			{
	...
	public override object ReadElementContentAs(Type returnType, IXmlNamespaceResolver namespaceResolver)
	{
		...
		object value = InternalReadElementContentAsObject(out var xmlType, unwrapTypedValue: false, out var originalString);
		try
		{
			if (xmlType != null)
			{
