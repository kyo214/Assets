...
public static class math
{
	...
	{
		IntFloatUnion intFloatUnion = default;
	...
	{
		LongDoubleUnion longDoubleUnion = default;
	...
	public static float f16tof32(uint x)
	{
		...
		return asfloat(select(num3, asuint(asfloat(num3 + 8388608) - 1f / 16384f), num2 == 0) | ((x & 0x8000) << 16));
	}
	...
	public static float2 f16tof32(uint2 x)
	{
		...
		return asfloat(select(obj2, asuint(asfloat(obj2 + 8388608u) - 1f / 16384f), uint5 == 0u) | ((x & 32768u) << 16));
	}
