...
public static class noise
{
	public static float2 cellular(float2 P)
	{
		...
		float3 float9 = math.frac(obj2 * (1f / 7f)) - 1755f / 4095f;
		float3 float10 = mod7(math.floor(obj2 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		...
		float9 = math.frac(obj3 * (1f / 7f)) - 1755f / 4095f;
		float10 = mod7(math.floor(obj3 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		...
		float9 = math.frac(obj4 * (1f / 7f)) - 1755f / 4095f;
		float10 = mod7(math.floor(obj4 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
	...
	public static float2 cellular2x2x2(float3 P)
	{
		...
		float4 float10 = math.frac(float9 * (1f / 7f)) - 1755f / 4095f;
		float4 float11 = mod7(math.floor(float9 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float4 float12 = math.floor(float9 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float4 float13 = math.frac(obj2 * (1f / 7f)) - 1755f / 4095f;
		float4 float14 = mod7(math.floor(obj2 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
	...
	public static float2 cellular(float3 P)
	{
		...
		float3 float19 = math.frac(float11 * (1f / 7f)) - 1755f / 4095f;
		float3 float20 = mod7(math.floor(float11 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float21 = math.floor(float11 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float22 = math.frac(float12 * (1f / 7f)) - 1755f / 4095f;
		float3 float23 = mod7(math.floor(float12 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float24 = math.floor(float12 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float25 = math.frac(float13 * (1f / 7f)) - 1755f / 4095f;
		float3 float26 = mod7(math.floor(float13 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float27 = math.floor(float13 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float28 = math.frac(float14 * (1f / 7f)) - 1755f / 4095f;
		float3 float29 = mod7(math.floor(float14 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float30 = math.floor(float14 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float31 = math.frac(float15 * (1f / 7f)) - 1755f / 4095f;
		float3 float32 = mod7(math.floor(float15 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float33 = math.floor(float15 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float34 = math.frac(float16 * (1f / 7f)) - 1755f / 4095f;
		float3 float35 = mod7(math.floor(float16 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float36 = math.floor(float16 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float37 = math.frac(float17 * (1f / 7f)) - 1755f / 4095f;
		float3 float38 = mod7(math.floor(float17 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float39 = math.floor(float17 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float40 = math.frac(float18 * (1f / 7f)) - 1755f / 4095f;
		float3 float41 = mod7(math.floor(float18 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
		float3 float42 = math.floor(float18 * (1f / 49f)) * (1f / 6f) - 5f / 12f;
		float3 float43 = math.frac(obj4 * (1f / 7f)) - 1755f / 4095f;
		float3 float44 = mod7(math.floor(obj4 * (1f / 7f))) * (1f / 7f) - 1755f / 4095f;
