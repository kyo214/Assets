...
public static class ContentLoadInterface
{
	...
	[MethodImpl(MethodImplOptions.InternalCall)]
	private unsafe static extern void LoadContentFileAsync_Injected(ref ContentNamespace nameSpace, string filename, void* dependencies, int dependencyCount, ref JobHandle dependentFence, [Optional][DefaultParameterValue(false)] bool useUnsafe, out ContentFile ret);
