...
public struct MMAudioSourcePitchShakeEvent
{
	...
	{
		OnEvent?.Invoke(pitchCurve, duration, remapMin, remapMax, relativePitch, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
	}
}
