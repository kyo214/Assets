...
public sealed class MethodBuilder : MethodInfo, _MethodBuilder
{
	...
	internal void fixup()
	{
		if ((attrs & (MethodAttributes.Abstract | MethodAttributes.PinvokeImpl)) == 0 && (iattrs & (MethodImplAttributes)0x1003) == 0 && (ilgen == null || ilgen.ILOffset == 0) && (code == null || code.Length == 0))
		{
