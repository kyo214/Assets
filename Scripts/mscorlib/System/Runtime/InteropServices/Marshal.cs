...
public static class Marshal
{
	...
	internal static ICustomMarshaler GetCustomMarshalerInstance(Type type, string cookie)
	{
		...
		LazyInitializer.EnsureInitialized(ref MarshalerInstanceCache, () => new Dictionary<ValueTuple<Type, string>, ICustomMarshaler>(new MarshalerInstanceKeyComparer()));
		bool flag;
