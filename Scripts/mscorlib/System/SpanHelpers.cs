...
internal static class SpanHelpers
{
	...
	public static void ClearWithReferences(ref IntPtr ip, ulong pointerSizeLength)
	{
		...
		{
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -1) = default;
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -2) = default;
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -3) = default;
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -4) = default;
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -5) = default;
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -6) = default;
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -7) = default;
			Unsafe.Add(ref Unsafe.Add(ref ip, (IntPtr)(long)pointerSizeLength), -8) = default;
			pointerSizeLength -= 8;
		}
	...
	public unsafe static void ClearPointerSizedWithoutReferences(ref byte b, UIntPtr byteLength)
	{
		...
		{
			Unsafe.As<byte, Reg64>(ref Unsafe.Add(ref b, zero)) = default;
		}
		if (zero.LessThanEqual(byteLength - sizeof(Reg32)))
		{
			Unsafe.As<byte, Reg32>(ref Unsafe.Add(ref b, zero)) = default;
			zero += sizeof(Reg32);
		}
		if (zero.LessThanEqual(byteLength - sizeof(Reg16)))
		{
			Unsafe.As<byte, Reg16>(ref Unsafe.Add(ref b, zero)) = default;
			zero += sizeof(Reg16);
		}
	...
	public static void ClearPointerSizedWithReferences(ref IntPtr ip, UIntPtr pointerSizeLength)
	{
		...
		{
			Unsafe.Add(ref ip, intPtr + 0) = default;
			Unsafe.Add(ref ip, intPtr + 1) = default;
			Unsafe.Add(ref ip, intPtr + 2) = default;
			Unsafe.Add(ref ip, intPtr + 3) = default;
			Unsafe.Add(ref ip, intPtr + 4) = default;
			Unsafe.Add(ref ip, intPtr + 5) = default;
			Unsafe.Add(ref ip, intPtr + 6) = default;
			Unsafe.Add(ref ip, intPtr + 7) = default;
			intPtr = zero;
		}
		...
		{
			Unsafe.Add(ref ip, intPtr) = default;
		}
	}
