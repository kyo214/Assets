...
public readonly struct Boolean : IComparable, IConvertible, IComparable<bool>, IEquatable<bool>
{
	...
	public bool TryFormat(Span<char> destination, out int charsWritten)
	{
		...
		if (((ReadOnlySpan<char>)text).TryCopyTo(destination))
		{
	...
	public static bool Parse(string value)
	{
		...
		return Parse((ReadOnlySpan<char>)value);
	}
	...
	public static bool TryParse(string value, out bool result)
	{
		...
		return TryParse((ReadOnlySpan<char>)value, out result);
	}
