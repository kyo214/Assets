...
public static class BitConverter
{
	...
	public static string ToString(byte[] value, int startIndex, int length)
	{
		...
		return string.Create(length * 3 - 1, new ValueTuple<byte[], int, int>(value, startIndex, length), (Span<char> dst, [TupleElementNames(new string[] { "value", "startIndex", "length" })] ValueTuple<byte[], int, int> state) =>
		{
