...
public class StreamWriter : TextWriter
{
	...
	public override Task WriteAsync(char[] buffer, int index, int count)
	{
		...
		CheckAsyncTaskInProgress();
		return _asyncWriteTask = WriteAsyncInternal(this, new ReadOnlyMemory<char>(buffer, index, count), _charBuffer, _charPos, _charLen, CoreNewLine, _autoFlush, appendNewLine: false, default);
	}
	...
	public override Task WriteLineAsync()
	{
		...
		CheckAsyncTaskInProgress();
		return _asyncWriteTask = WriteAsyncInternal(this, ReadOnlyMemory<char>.Empty, _charBuffer, _charPos, _charLen, CoreNewLine, _autoFlush, appendNewLine: true, default);
	}
	...
	public override Task WriteLineAsync(char[] buffer, int index, int count)
	{
		...
		CheckAsyncTaskInProgress();
		return _asyncWriteTask = WriteAsyncInternal(this, new ReadOnlyMemory<char>(buffer, index, count), _charBuffer, _charPos, _charLen, CoreNewLine, _autoFlush, appendNewLine: true, default);
	}
