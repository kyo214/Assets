...
public class SemaphoreSlim : IDisposable
{
	...
	private static readonly Task<bool> s_trueTask = new Task<bool>(canceled: false, result: true, (TaskCreationOptions)16384, default);

	private static readonly Task<bool> s_falseTask = new Task<bool>(canceled: false, result: false, (TaskCreationOptions)16384, default);
	...
	{
		using (CancellationTokenSource cts = (cancellationToken.CanBeCanceled ? CancellationTokenSource.CreateLinkedTokenSource(cancellationToken, default) : new CancellationTokenSource()))
		{
