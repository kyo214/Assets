...
public class AutoFilterRecord : StandardRecord
{
	...
	{
		return new AutoFilterRecord
		{
			field_1_iEntry = field_1_iEntry,
			field_2_grbit = field_2_grbit,
			field_3_doper1 = field_3_doper1,
			field_4_doper2 = field_4_doper2,
			field_5_rgch1 = field_5_rgch1,
			field_6_rgch2 = field_6_rgch2
		};
	}
