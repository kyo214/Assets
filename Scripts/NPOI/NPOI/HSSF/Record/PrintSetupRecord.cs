...
public class PrintSetupRecord : StandardRecord
{
	...
	public override object Clone()
	{
		...
		{
			field_1_paper_size = field_1_paper_size,
			field_2_scale = field_2_scale,
			field_3_page_start = field_3_page_start,
			field_4_fit_width = field_4_fit_width,
			field_5_fit_height = field_5_fit_height,
			field_6_options = field_6_options,
			field_7_hresolution = field_7_hresolution,
			field_8_vresolution = field_8_vresolution,
			field_9_headermargin = field_9_headermargin,
			field_10_footermargin = field_10_footermargin,
			field_11_copies = field_11_copies
		};
	}
}
