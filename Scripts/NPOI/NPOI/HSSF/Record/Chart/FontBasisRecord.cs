...
public class FontBasisRecord : StandardRecord, ICloneable
{
	...
	{
		return new FontBasisRecord
		{
			field_1_xBasis = field_1_xBasis,
			field_2_yBasis = field_2_yBasis,
			field_3_heightBasis = field_3_heightBasis,
			field_4_scale = field_4_scale,
			field_5_indexToFontTable = field_5_indexToFontTable
		};
	}
}
