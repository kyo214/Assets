...
public class AxcExtRecord : StandardRecord
{
	...
	public override object Clone()
	{
		...
		{
			field_1_catMin = field_1_catMin,
			field_2_catMax = field_2_catMax,
			field_3_catMajor = field_3_catMajor,
			field_4_duMajor = field_4_duMajor,
			field_5_catMinor = field_5_catMinor,
			field_6_duMinor = field_6_duMinor,
			field_7_duBase = field_7_duBase,
			field_8_catCrossDate = field_8_catCrossDate,
