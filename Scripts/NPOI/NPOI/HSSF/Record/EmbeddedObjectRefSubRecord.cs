...
public class EmbeddedObjectRefSubRecord : SubRecord, ICloneable
{
	...
	{
		field_2_unknownFormulaData = new byte[5] { 2, 108, 106, 22, 1 };
	...
	public override void Serialize(ILittleEndianOutput out1)
	{
		...
		{
		case 1:
			out1.WriteByte(field_4_unknownByte.HasValue ? Convert.ToByte(field_4_unknownByte, CultureInfo.InvariantCulture) : 0);
			num2++;
			break;
		default:
	...
	public override string ToString()
	{
		...
		if (field_4_unknownByte.HasValue)
		{
