...
public class SupBookRecord : StandardRecord
{
	...
	public string URL
	{
		get
		{
			...
			return (int)text[0] switch
			{
				0 => text.Substring(1), 
				1 => DecodeFileName(text), 
				2 => text.Substring(1), 
				_ => text, 
			};
		}
	...
	public override string ToString()
	{
		...
		if (IsExternalReferences)
		{
			...
			stringBuilder.Append(" .url     = ").Append(field_2_encoded_url).Append("\n");
			stringBuilder.Append(" .nSheets = ").Append(field_1_number_of_sheets).Append("\n");
			string[] array = field_3_sheet_names;
