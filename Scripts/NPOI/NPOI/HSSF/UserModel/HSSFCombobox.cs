...
public class HSSFCombobox : HSSFSimpleShape
{
	...
	{
		base.ShapeType = 201;
		((CommonObjectDataSubRecord)GetObjRecord().SubRecords[0]).ObjectType = CommonObjectType.ComboBox;
	}
	...
	protected override EscherContainerRecord CreateSpContainer()
	{
		...
		HSSFClientAnchor obj = (HSSFClientAnchor)base.Anchor;
		obj.AnchorType = (AnchorType)1;
		EscherRecord escherAnchor = obj.GetEscherAnchor();
	...
	protected override ObjRecord CreateObjRecord()
	{
		...
		{
			ObjectType = CommonObjectType.ComboBox,
			IsLocked = true,
			IsPrintable = false,
			IsAutoFill = true,
			IsAutoline = false
		};
		FtCblsSubRecord o2 = new FtCblsSubRecord();
		LbsDataSubRecord o3 = LbsDataSubRecord.CreateAutoFilterInstance();
		EndSubRecord o4 = new EndSubRecord();
		objRecord.AddSubRecord(o);
		objRecord.AddSubRecord(o2);
		objRecord.AddSubRecord(o3);
		objRecord.AddSubRecord(o4);
		return objRecord;
	}
}
