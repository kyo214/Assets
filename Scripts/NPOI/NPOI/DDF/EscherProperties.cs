...
public class EscherProperties
{
	...
	public const short LINESTYLE__NOLINEDRAWDASH_LEFT = 1407;

	public const short LINESTYLE__NOLINEDRAWDASH_TOP = 1471;

	public const short LINESTYLE__NOLINEDRAWDASH_BOTTOM = 1599;

	public const short LINESTYLE__NOLINEDRAWDASH_RIGHT = 1535;
	...
	private static void InitProps()
	{
		if (properties == null)
		{
			...
			AddProp(467, GetData("linestyle.linestartarrowlength"));
			...
			AddProp(1407, GetData("linestyle.nolinedrawdash.left", 1));
			AddProp(1471, GetData("linestyle.nolinedrawdash.top", 1));
			AddProp(1599, GetData("linestyle.nolinedrawdash.bottom", 1));
			AddProp(1535, GetData("linestyle.nolinedrawdash.right", 1));
