...
public class EscherDump
{
	...
	public void DumpOld(long maxLength, Stream in1)
	{
		...
		while (!flag && num > 0)
		{
			...
			num -= 8;
			string value = num3 switch
			{
				-4096 => "MsofbtDggContainer", 
				-4090 => "MsofbtDgg", 
				-4074 => "MsofbtCLSID", 
				-4085 => "MsofbtOPT", 
				-4095 => "MsofbtBstoreContainer", 
				-4089 => "MsofbtBSE", 
				-4094 => "MsofbtDgContainer", 
				-4088 => "MsofbtDg", 
				-4093 => "MsofbtSpgrContainer", 
				-4092 => "MsofbtSpContainer", 
				-4087 => "MsofbtSpgr", 
				-4086 => "MsofbtSp", 
				-4084 => "MsofbtTextbox", 
				-4083 => "MsofbtClientTextbox", 
				-4082 => "MsofbtAnchor", 
				-4081 => "MsofbtChildAnchor", 
				-4080 => "MsofbtClientAnchor", 
				-4079 => "MsofbtClientData", 
				-4091 => "MsofbtSolverContainer", 
				-4078 => "MsofbtConnectorRule", 
				-4077 => "MsofbtAlignRule", 
				-4076 => "MsofbtArcRule", 
				-4075 => "MsofbtClientRule", 
				-4073 => "MsofbtCalloutRule", 
				_ => num3 switch
				{
					-3814 => "MsofbtColorMRU", 
					-3810 => "MsofbtSplitMenuColors", 
					-3816 => "MsofbtRegroupItem", 
					-3808 => "MsofbtColorScheme", 
					-3809 => "MsofbtOleObject", 
					-3811 => "MsofbtDeletedPspl", 
					-3815 => "MsofbtSelection", 
					-3806 => "MsofbtUDefProp", 
					_ => (num3 >= -4072 && num3 <= -3817) ? "MsofbtBLIP" : (((num2 & 0xF) != 15) ? "UNKNOWN ID" : "UNKNOWN container"), 
				}, 
			};
	...
	{
		return string.Concat(string.Concat("" + (short)(n32 >> 16), "."), ((short)(n32 & 0xFFFF)).ToString());
	}
