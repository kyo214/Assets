...
public abstract class FinanceFunction : Function3Arg, Function, Function4Arg
{
	...
	public ValueEval Evaluate(ValueEval[] args, int srcRowIndex, int srcColumnIndex)
	{
		...
		case 4:
		{
			ValueEval valueEval = args[3];
			if (valueEval == MissingArgEval.instance)
			{
				valueEval = DEFAULT_ARG3;
			}
			return Evaluate(srcRowIndex, srcColumnIndex, args[0], args[1], args[2], valueEval, DEFAULT_ARG4);
		}
		case 5:
		{
			ValueEval valueEval = args[3];
			...
			ValueEval valueEval2 = args[4];
			if (valueEval2 == MissingArgEval.instance)
			{
				valueEval2 = DEFAULT_ARG4;
			}
			return Evaluate(srcRowIndex, srcColumnIndex, args[0], args[1], args[2], valueEval, valueEval2);
		}
		default:
