...
public class AttrPtg : ControlPtg
{
	public enum SpaceType
	{
		SpaceBefore = 0,
		CrBefore = 1,
		SpaceBeforeOpenParen = 2,
		CrBeforeOpenParen = 3,
		SpaceBeforeCloseParen = 4,
		CrBeforeCloseParen = 5,
		SpaceAfterEquality = 6
	}
	...
	public AttrPtg(ILittleEndianInput in1)
	{
		...
		{
			int[] array = new int[field_2_data];
	...
	{
		int data = (int)(type & (SpaceType)0xFF) | ((count << 8) & 0xFFFF);
