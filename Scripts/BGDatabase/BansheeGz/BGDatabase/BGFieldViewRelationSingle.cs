...
public class BGFieldViewRelationSingle : BGFieldManyRelationsSingle, BGFieldViewRelationI
{
	...
	public new const ushort CodeType = 97;

	private BGMetaView view;

	private BGId viewId;

	public override ushort TypeCode => 97;
	...
	public BGFieldViewRelationSingle(BGMetaEntity meta, string name, BGMetaView to)
	...
	internal BGFieldViewRelationSingle(BGMetaEntity meta, BGId id, string name)
		: base(meta, id, name)
	{
	}
	...
	{
		return (BGMetaEntity meta, BGId id, string name) => new BGFieldViewRelationSingle(meta, id, name);
	}
